                    ...
                    <th class="report-header-cell">
                        <div class="header-info" style="display: flex; align-items: center;">
                            ...
                            <div style="width: 200px; text-align: left">
                                <div>
                                    <asp:Label ID="lbPatientName" runat="server"></asp:Label></div>
                                <div>
                                    <asp:Label ID="lbDoB" runat="server"></asp:Label></div>
                                <div>
                                    <asp:Label class="font-bold" ID="lbPID" runat="server"></asp:Label></div>
                            </div>
                        </div>
                    ...
                    <td class="report-content-cell">
                        <div class="main" runat="server" id="print_content">
                            ...
                            <div class="row mb-2">
                              ...
                              <div class="row mb-2">
                                <div class="col-12">
                                    <webUI:Label runat="server" CssClass="font-bold" Title="I. LÝ DO ĐẾN KHÁM:" SubTitle="CHIEFT COMPLAINT" />
                            ...
                            <div class="row mb-2">
                                <div class="col-12">
                                    <webUI:Label runat="server" CssClass="font-bold" Title="III. TIỀN SỬ BỆNH:" SubTitle="CHIEFT COMPLAINT" />
