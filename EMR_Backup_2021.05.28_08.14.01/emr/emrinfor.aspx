...
<body>
    <form id="form1" runat="server">
        ...
        <section style="width: 100%; height: calc(100% - 53px);">
                    ...
                    <div class="scroll-sidebar w-100">
                        <nav class="sidebar-wrapper" style="position: initial; width: inherit">
                                ...
                                <asp:UpdatePanel ID="updatePanel_main" runat="server" UpdateMode="Always">
                                    <ContentTemplate>
                                        <ul class="text-nowrap">
                                            <li>
                                                <a href="../other/patientsummary.aspx?pid=<%= varPID %>" class="bnt-link" target="MainContent">Patient Summary</a>
                                            </li>
                           ...
                           NavigateUrl ="http://172.16.0.78:8082/api/omr/0d79db3e-ae3f-433e-a1d2-aa96107654e1"                           
                                                                        ...
                                                                        <a runat="server" data-varpid='<%# varPID %>' data-varvpid='<%# varVPID %>' data-modelid='<%#Eval("model_id") %>' data-documentid='<%#Eval("document_id") %>' id="lblURL" href="javascript:void(0);" onclick='lblURL_click(this)'><%# ReturnForm_Name(Eval("status"),Eval("model_name"),Eval("created_name_e")) %></a>
                                                                    </ItemTemplate>
        ...
        function lblURL_click(args) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    document.getElementById("RAD_SPLITTER_PANE_EXT_CONTENT_MainContent").src = String(msg.d);
                }
            });
        }
    </script>
