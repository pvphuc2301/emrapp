                                ...
                                <div class="border mb-4 pt-2">
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>Chiều cao/ <i class="text-primary">Height</i>: <asp:Label runat="server" ID="lblHeight" /> cm; Cân nặng/ <i class="text-primary">Weight</i>: <asp:Label runat="server" ID="lblWeight" /> kg </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Dị ứng/ <i class="text-primary">Allery</i>: <asp:Label runat="server" ID="lbAllergy" /></td>
                                        </tr>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="note" HeaderButtonType="TextButton" UniqueName="note"
                            ...
                            DataField="note">
                                ...
                                <div class="d-grid mt-4" style="grid-template-columns: 1fr 1fr; grid-gap: 5px">
                                    <div></div>
