<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicalCertificate.aspx.cs" Inherits="EMR.DBP.OPD.MedicalCertificate" ValidateRequest="false" %>
                                ...
                                <td class="report-content-cell">
                                    <div class="main">
                                        ...
                                        <div style="margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" Title="PHÒNG KHÁM QUỐC TẾ MỸ CHỨNG NHẬN:" SubTitle="AMERICAN INTERNATIONAL CLINIC CERTIFIES THAT" runat="server" />
                                        </div>
                                        ...
                                        <div class="d-grid mt-1" style="grid-template-columns: 200px 1fr 200px; margin-bottom: 6px;">
                                            <div class="d-grid" style="grid-template-columns: auto 1fr">
                                                <webUI:PrtRowS1 FontBold="true" FixedWidth="80" Title="Ngày sinh:" SubTitle="DOB" runat="server" />
                                                <asp:Label runat="server" ID="prt_dob" />
                                            </div>
                                            <div class="d-grid" style="grid-template-columns: auto 1fr; margin-bottom: 6px;">
                                                <webUI:PrtRowS1 FontBold="true" FixedWidth="80" Title="Giới tính:" SubTitle="Gender" runat="server" />
                                            ...
                                            <div class="d-grid" style="grid-template-columns: auto 1fr">
                                                <webUI:PrtRowS1 FontBold="true" FixedWidth="80" Title="MS người bệnh:" SubTitle="Patient ID" runat="server" />
                                                <asp:Label runat="server" ID="prt_pid" />
                                            </div>
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="100" Title="Khoa:" SubTitle="Dept" runat="server" Value="Khoa khám bệnh" />
                                        ...
                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="1. Ngày khám bệnh:" SubTitle="Date of visit" runat="server" />
                                            <asp:Label runat="server" ID="prt_date_of_visit" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="2. Lý do đến khám:" SubTitle="Chief complaint" runat="server" />
                                            <asp:Label runat="server" ID="prt_chief_complain" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="3. Tóm tắt bệnh sử:" SubTitle="History of present illness" runat="server" />
                                            <asp:Label runat="server" ID="prt_history_present_illness" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="4. Tiền sử bệnh:" SubTitle="Past history" runat="server" />
                                            <asp:Label runat="server" ID="prt_past_history" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="5. Đặc điểm lâm sàng:" SubTitle="Clinical findings" runat="server" />
                                            <asp:Label runat="server" ID="prt_clinical_findings" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="6. Cận lâm sàng được chỉ định:" SubTitle="Para-clinical investigations" runat="server" />
                                            <asp:Label runat="server" ID="prt_para_clinical_investigations" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="7. Chẩn đoán:" SubTitle="Diagnosis" runat="server" />
                                            <asp:Label runat="server" ID="prt_diagnosis" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="230" Title="8. Phương pháp và thuốc điều trị:" SubTitle="Treatment and medications" runat="server" />
                                            <asp:Label runat="server" ID="prt_treatment" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px; margin-bottom: 6px;">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="9. Thời gian điều trị:" SubTitle="Treatment period" runat="server" />
                                            <asp:Label runat="server" ID="prt_treatment_period" />
                                        </div>

                                        <div class="d-grid" style="grid-template-columns: auto 1fr; grid-gap: 5px">
                                            <webUI:PrtRowS1 FontBold="true" FixedWidth="210" Title="10. Lời khuyên và theo dõi:" SubTitle="Recommendation and Follow-up" runat="server" />
                                        ...
                                        <div class="d-grid" style="grid-template-columns: 1fr 1fr; grid-gap: 5px">
                                            ...
                                            <div class="text-center" style="break-inside: avoid !important; page-break-inside: avoid !important">
                                                ...
                                                <div><span class="font-bold">BÁC SĨ ĐIỀU TRỊ</span>/ ATTENDING DOCTOR</div>
                                                <div>(Họ tên, chữ ký & MSNV)/ (Name, signature & ID)</div>
