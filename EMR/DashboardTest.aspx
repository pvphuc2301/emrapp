<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardTest.aspx.cs" Inherits="EMR.DashboardTest" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="display: grid; grid-template-columns: auto 1fr; height:100vh;">
            <telerik:RadTabStrip RenderMode="Lightweight" runat="server" ID="RadTabStrip2"  MultiPageID="RadMultiPage2"
                    Orientation="VerticalLeft" Width="160px" SelectedIndex="0">
                    <Tabs>
                        ...
                        <%--<telerik:RadTab ImageUrl="images/icon_Soups.png" ToolTip="Soups" SelectedImageUrl="images/icon_Soups.png" HoveredImageUrl="images/icon_Soups.png"></telerik:RadTab>--%>
                    </Tabs>
                </telerik:RadTabStrip>
            <div>
