    ...
    <form method="post" action="#" id="form2" runat="server">
        ...
        <asp:UpdatePanel ID="Upd" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="cssclsNoPrint" style="font-family: Tahoma !important; font-size: 13.3048px !important;">
                                                    ...
                                                    <div class="col-md-12 mb-2" runat="server" id="habits_field">
                                                        <fieldset class="row mb-2">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <asp:Label runat="server" ID="lbl_habits_smoking" Css />
                                                            </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <asp:Label runat="server" ID="lbl_habits_alcohol" Css />
                                                            </div>
                                                            <div class="col-md-12">
                                                                <asp:Label runat="server" ID="Label1" Css />
                                                                <div class="custom-control custom-radio d-inline-block">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <asp:Label runat="server" ID="lbl_habits_drugs" Css />
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="custom-control custom-radio d-inline-block">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mb-2 d-flex no-block">
                                                        ...
                                                        <asp:Label runat="server" ID="lbl_vs_temperature" Css />
                                                    </div>
                                                    <div class="col-sm-6 mb-2 d-flex no-block">
                                                        <label class="control-label mb-1 mr-2">Nhịp tim/ <span class="text-primary">rate:</span></label>
                                                        <asp:Label runat="server" ID="lbl_vs_heart_rate" Css />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mb-2 d-flex no-block">
                                                        ...
                                                        <asp:Label runat="server" ID="lbl_vs_weight" Css />
                                                    </div>
                                                    <div class="col-sm-6 mb-2 d-flex no-block">
                                                        <label class="control-label mb-1 mr-2">Nhịp thở/ <span class="text-primary">Respiratory rate:</span></label>
                                                        <asp:Label runat="server" ID="lbl_vs_respiratory_rate" Css />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mb-2 d-flex no-block">
                                                        ...
                                                        <asp:Label runat="server" ID="lbl_vs_height" Css />
                                                    </div>
                                                    <div class="col-sm-6 mb-2 d-flex no-block">
                                                        <label class="control-label mb-1 mr-2">Huyết áp/ <span class="text-primary">Blood Pressure:</span></label>
                                                        <asp:Label runat="server" ID="lbl_vs_blood_pressure" Css />
                                                    </div>
                                                </div>
        ...
        applicable for children and pregnant</span>)
                                        ...
                                        <div class="row" runat="server" id="treatmentWrapper">
                                            <div class="col-md-4">
                                        ...
                                        <div class="row mb-2" runat="server" id="SpecOpinionRequestedWrapper">
                                            <div class="col-md-4 ">
                                                <div class="custom-control custom-radio">
