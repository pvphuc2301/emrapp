...
<body>
    <form id="form1" runat="server">
                                ...
                                <div class="card v20">
                                    ...
                                    <div class="card-body collapse show" id="collapseOne">
                                        <div class="form-body mb-4">
                                            ...
                                            <div class="dg-1 mb-1">
                                                <label for="bmi" class="control-label mb-1 mr-2">
                                                    Chỉ số khối cơ thể/ <span class="text-primary">BMI</span>
        ...
        applicable for children and pregnant</span>)</div>
                                            ...
                                            <div class="mb-1"><label class="control-label font-bold">FLACC (2 tháng - < 4 tuổi) và bệnh nhi dưới 16 tuổi không nói được/ <span class="text-primary">2 month to < 4 years old and non-verbal pediatric patient (patient < 16 years old)</span></label></div>
                                            ...
                                            <div>
                                                ...
                                                <div><label class="font-bold"> - Câu hỏi sàng lọc/ <span class="text-primary">The fall risk screen question</span>:</label></div>
                                                
                                                <div class="mb-1">a. Anh/chị/ông/bà có từng bị ngã trong 12 tháng gần đây không?/ <span class="text-primary">Have you fallen in the past year?</span></div>
                                                ...
                                                <div class="mb-1">b. Anh/chị/ông/bà có cảm thấy bị mất thăng bằng lúc đứng dậy hoặc lúc đi không?/ <span class="text-primary">Do you feel unsteady when standing or walking?</span></div>
                                                ...
                                                <div class="mb-1">c. Anh/chị/ông/bà có lo sợ bị ngã không?/ <span class="text-primary">Do you worry about falling?</span></div>
                                                ...
                                                <div class="mb-1"><label class="font-bold">- Can thiệp/ <span class="text-primary">Intervention</span>:</label></div>
                                            ...
                                            <div class="mb-1"><label class="control-label font-bold">IV. MỨC ĐỘ ƯU TIÊN/ <span class="text-primary">PRIORITIZATION</span></label></div>
