                                ...
                                <div class="card-body">
                                    <div class="form-body collapse show" id="collapseOne">
                                        ...
                                        <fieldset class="row mb-2">
                                            ...
                                            <div class="col-12 mb-2" runat="server" id="treatment_code_wrapper">
                                                <div class="custom-control custom-radio  d-inline-block mr-2 d-inline-block">
                                        ...
                                        <fieldset class="row mb-2">
                                            ...
                                            <div class="col-md-12 mb-2" runat="server" id="spec_opinion_req_wrapper">
                                                <div class="custom-control custom-radio d-inline-block mr-2 d-inline-block">
                                        ...
                                        <fieldset class="row mb-2">
                                            ...
                                            <div class="col-md-12 mb-2" runat="server" id="pecific_edu_req_wrapper">
                                        ...
                                        <fieldset class="row mb-2">
                                            ...
                                            <div class="col-md-12 mb-2" runat="server" id="next_appointment_wrapper">
