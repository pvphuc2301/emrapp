    ...
    public partial class OutPatMedRecPed_v02 : System.Web.UI.Page
    {
        ...
        private void BindingDataFormView(POMR pomr)
        {
            try
            {
                ...
                lbl_physical_examination.Text = WebHelpers.TextToHtmlTag(pomr.physical_examination).Replace("•", "<br>");
        ...
        public void Initial()
        {
            try
            {
                ...
                RadLabel1.Text = WebHelpers.loadRadGridHistoryLog(RadGrid1, POMR.Logs(varDocID, loc), out string _SignatureDate, out string _SignatureName);
