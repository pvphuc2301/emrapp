...
namespace EMR.Print
{
    public partial class PrtOPMedRec : System.Web.UI.Page
    {
        string amendReason = "";
        ...
        public void loadDataToOMRControls(Omr omr1)
        {
            ...
            txtMedicalHistory.Value = lbmedical_history.Text = omr1.medical_history;
            txtCurrentMedication.Value = omr1.current_medication;

            // 2.Tiền sử bệnh/ Antecedent Medical History:
            txtPersonal.Value = lbPersonal.Text = omr1.personal;
