                            ...
                            <tr>
                                <td class="report-content-cell">
                                    <div class="main" runat="server" id="print_content">
                                        ...
                                        <div class="row mb-2 ">
                                            <div class="col-12 " style="text-align: justify; font-size: 14.5px; font-family: Tahoma">
                                                <asp:Label Style="font-weight: bold;" runat="server"> Đã từng nhiễm COVID-19 trong vòng 6 tháng qua</span>/ <span class="text-primary">Have been injected with COVID-19 within the last 6 months:</span> </asp:Label>
                                            </div>
                                        </div>
                            ...
                            <div class="card v20">
                                ...
                                <div class="card-body collapse show" id="collapseOne">
                                    <div class="form-body">
                                        ...
                                        <div class="add-v20">
                                            <label class="control-label"><span class="font-bold">Đã từng nhiễm COVID-19 trong vòng 6 tháng qua</span>/ <span class="text-primary">Have been injected with COVID-19 within the last 6 months:</span></label>
                                            <div class="dg-1">
                                                <div></div>
