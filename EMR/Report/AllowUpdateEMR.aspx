...
<body>
    <form method="post" action="#" id="form2" runat="server">
        ...
        <br /><br />
        <div>
            <%--<div><b>From:</b><telerik:RadDatePicker ID="FromDate" runat="server" Width="180" TabIndex="1"/></div>
            <div><b>To:</b><telerik:RadDatePicker ID="ToDate" runat="server" Width="180" TabIndex="2"/></div>--%>
            <asp:Linkbutton ID="ExportGroup" CssClass="btn btn-outline-secondary m-2" Text="Export to Excel" OnClick="ButtonExport_Click" runat="server" />
        </div>
        <telerik:RadGrid OnNeedDataSource="RadGrid1_NeedDataSource" AllowSorting="true" ItemStyle-Height="32px" HeaderStyle-Height="32px" CssClass="table" 
                                            BorderWidth="0" OnDataBound="RadGrid1_DataBound" AutoGenerateColumns="false" ID="RadGrid1" runat="server" AllowPaging="True" OnItemCommand="RadGrid1_ItemCommand" 
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="visible_patient_id, patient_visit_id, visit_type_rcd, closure_date_time, allow_date_time">
                <Columns>
                    <telerik:GridTemplateColumn ItemStyle-Width="100px" Exportable="false">
                        <HeaderTemplate>
                            <div>Allow</div>
                        </HeaderTemplate>
                        <ItemTemplate>
