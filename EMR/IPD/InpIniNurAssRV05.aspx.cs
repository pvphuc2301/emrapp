...
namespace EMR
{
    public partial class InpIniNurAssRV05 : EmrPageV01
    {
        ...
        {
            Model.arrival_date_time = DateTime.Now;
            Model.assess_date_time = DateTime.Now;

            #region I. THÔNG TIN TỔNG QUÁT VỀ NGƯỜI BỆNH/ GENERAL PATIENT INFORMATION
            Model.residence_code = "OTH"; //1
            Model.residence_desc = "Khác/ Other";
            Model.residence_other = "Unknown";

            Model.language_code = "OTH"; //1
            Model.language_desc = "Tiếng khác, ghi rõ/ Other language, specify";
            Model.language_other = "Unknown";

            Model.req_interpreter = true;

            Model.religion_code = "OTH"; //1
            Model.religion_desc = "Khác/ Other";
            ...
            Model.living_status_code = "OTH";//1
            Model.living_status_desc = "Khác/ Other";
            Model.living_status_note = "Unknown";

            Model.hospital_concern_code = "OTH";//1
            Model.hospital_concern_desc = "Khác/ Others";
            Model.hospital_concern_other = "Unknown";
            ...
            Model.admit_from_desc = "Khác/Referral";
            Model.admit_from_other = "Unknown";//4

            Model.arrived = "[{\"code\":\"W\",\"desc\":\"Tự đi được/ Walking\"},{\"code\":\"WC\",\"desc\":\"Bằng xe lăn/ Wheelchair\"},{\"code\":\"S\",\"desc\":\"Bằng băng ca/ Stretcher\"},{\"code\":\"O\",\"desc\":\"Khác/ Other\"}]";
            Model.arrived_other = "Khác";
            ...
            Model.extremities_other = "extremities_specify";
            //4.
            ...
            Model.mental_status = "[{\"code\":\"AL\",\"desc\":\"Tỉnh táo/ Alert\"},{\"code\":\"CF\",\"desc\":\"Nhầm lẫn/ Confused\"},{\"code\":\"AG\",\"desc\":\"Kích động/ Agitated\"},{\"code\":\"AN\",\"desc\":\"Lo âu/ Anxious\"},{\"code\":\"DE\",\"desc\":\"Trầm cảm/ Depressed\"},{\"code\":\"OTH\",\"desc\":\"Khác/ Other\"}]";
            Model.mental_status_other = "mental_status_other";

            Model.hearing_code = "N";
            Model.hearing_desc = "Bình thường/ Normal";

            Model.vision_code = "OTH";
            Model.vision_desc = "Khác/ Other";
            Model.vision_other = "vision_other";

            Model.speech_code = "NM";
            Model.speech_desc = "Bình thường/ Normal";

            //5
            Model.diet_code = "OTH";
            Model.diet_desc = "Khác/ Other";
            Model.diet_other = "diet_other";

            Model.diet_pre_code = "V";
            Model.diet_pre_desc = "Nôn/ Vomiting";

            Model.ng_tube = false;
            Model.gastrostomy = false;
            Model.size = true;
            Model.size_note = "4";
            Model.last_date_changed = DateTime.Now;

            Model.food_dislike = "food_dislike";

            Model.bowel_elimination_code = "OTH";
            Model.bowel_elimination_desc = "Khác/ Other";
            Model.bowel_elimination_other = "bowel_elimination_specify";

            Model.stool_consistency_code = "H";
            Model.stool_consistency_desc = "Cứng/ Hard";

            Model.gas_presence_code = "S";
            Model.gas_presence_desc = "Hậu môn nhân tạo/ Artificial anus";
            Model.gas_presence_note = "gas_presence_note";

            //6
            Model.urination = "[{\"code\":\"NM\",\"desc\":\"Bình thường/ Normal\"},{\"code\":\"NO\",\"desc\":\"Tiểu đêm/ Nocturia\"},{\"code\":\"DY\",\"desc\":\"Khó tiểu/ Dysuria\"},{\"code\":\"IN\",\"desc\":\"Không kiểm soát/ Incontinece\"}]";
            Model.inter_catheter = true;
            Model.inter_catheter_note = "1";

            Model.ind_catheter = true;
            Model.ind_catheter_size = "1";
            Model.ind_catheter_date = DateTime.Now;

            Model.sup_catheter = true;
            Model.sup_catheter_size = "1";
            Model.last_sup_catheter_date = DateTime.Now;

            Model.menstruation_code = "AM"; //"[{\"code\":\"AM\",\"desc\":\"Vô kinh/ Amenorrhea\"},{\"code\":\"ME\",\"desc\":\"Mãn kinh/ Menopause\"},{\"code\":\"CY\",\"desc\":\"Chu kỳ (ngày)/ Cycle (day)\"}]";
            Model.menstruation_desc = "Vô kinh/ Amenorrhea";

            Model.cycle_day = "1";
            Model.last_mens_period = "1";
            Model.not_pregnancy = true;
            Model.pre_pregnancy = true;
            Model.para = "1";
            Model.cur_pregnancy = true;
            Model.pregnancy_week = "1";

            Model.contraception_code = "OTH";
            Model.contraception_desc = "Khác/ Other";
            Model.contraception_other = "contraception_other";
            #endregion

            #region 7.
            Model.mus_history = "[{\"code\":\"JP\",\"desc\":\"Đau khớp/ Joint pain\"},{\"code\":\"MS\",\"desc\":\"Sự co rút cơ/ Muscle spasms\"},{\"code\":\"NM\",\"desc\":\"Bình thường/ Normal\"},{\"code\":\"JS\",\"desc\":\"Sưng khớp/ Joint swelling\"}]";
            
            Model.paralysis = true;
            Model.paralysis_note = "4 chi";

            Model.amputation = true;
            Model.amputation_note = "amputation_note";

            Model.contracture = true;
            Model.contracture_note = "contracture_note";

            Model.prosthesis = true;
            Model.prosthesis_note = "prosthesis_note";

            Model.cur_in_pain = true;

            #endregion

            Model.bathing_code = "IN";

            Model.oral_care_code = "OTH";
            Model.oral_care_note = "3";

            Model.dentures_code = "N";

            Model.toilet_use_code = "IN";

            Model.dressing_code = "IN";

            Model.eating_code = "IN";

            Model.turning_bed_code = "IN";

            Model.ambulation_code = "NA";
            Model.ambulation_note = "ambulation_note";

            Model.sleep_code = "NM";

            Model.medication_used = "medication_used";

            #region 11. Đánh giá nguy cơ té ngã sử dụng Bảng Morse Scale/ Fall risk assessment with Morse Scale 
            Model.fall_history_code = "0";
            Model.secon_diagnosis_code = "0";
            Model.ambula_aids_code = "0";
            Model.intra_therapy_code = "0";
            Model.gait_trans_code = "0";
            Model.fr_mental_status_code = "0";
            Model.fr_total_score = 0;
            ...
            Model.condition = "[{\"code\":\"NM\",\"desc\":\"\"},{\"code\":\"PA\",\"desc\":\"\"},{\"code\":\"FL\",\"desc\":\"\"},{\"code\":\"JA\",\"desc\":\"\"},{\"code\":\"DR\",\"desc\":\"\"},{\"code\":\"OI\",\"desc\":\"\"},{\"code\":\"SW\",\"desc\":\"\"},{\"code\":\"RA\",\"desc\":\"\"}]";
            Model.wounds = "[{\"code\":\"0\",\"desc\":\"\"},{\"code\":\"1\",\"desc\":\"\"},{\"code\":\"2\",\"desc\":\"\"},{\"code\":\"3\",\"desc\":\"\"},{\"code\":\"4\",\"desc\":\"\"},{\"code\":\"5\",\"desc\":\"\"},{\"code\":\"6\",\"desc\":\"\"}]";
            #endregion
            ...
            Model.instructions_provided_to = "[{\"code\":\"PAT\",\"desc\":\"Người bệnh/ Patient\"},{\"code\":\"REL\",\"desc\":\"Thân nhân/ Relative\"},{\"code\":\"OTH\",\"desc\":\"Khác/ Other\"},{\"code\":\"NAP\",\"desc\":\"Không áp dụng/ Not applicable\"}]";
            Model.instructions_provided_to_other = "other";
            ...
            Model.vb_dentures = true;
            Model.vb_dentures_note = "[{\"code\":\"WPA\",\"desc\":\"NB giữ/ With patient\"},{\"code\":\"WRE\",\"desc\":\"Thân nhân giữ/ With relative\"},{\"code\":\"MAX\",\"desc\":\"Hàm trên/ Maxilla\"},{\"code\":\"MAN\",\"desc\":\"Hàm dưới/ Mandible\"},{\"code\":\"PAR\",\"desc\":\"Từng phần/ Partial\"}]";
            //Model.vb_hearing_aid = "[{\"code\":\"NO\",\"desc\":\"Không/ No\"}]";
            Model.vb_hearing_aid = true;
            Model.vb_hearing_aid_note = "[{\"code\":\"WPA\",\"desc\":\"NB giữ/ With patient\"},{\"code\":\"WRE\",\"desc\":\"Thân nhân giữ/ With relative\"},{\"code\":\"LEF\",\"desc\":\"Trái/ Left\"},{\"code\":\"RIG\",\"desc\":\"Phải/ Right\"}]";
            //Model.vb_eyeglasses = "[{\"code\":\"NO\",\"desc\":\"Không/ No\"}]";
            Model.vb_eyeglasses = true;
            Model.vb_eyeglasses_note = "[{\"code\":\"WPA\",\"desc\":\"NB giữ/ With patient\"},{\"code\":\"WRE\",\"desc\":\"Thân nhân giữ/ With relative\"}]";
            //Model.vb_contact_lenses = "[{\"code\":\"NO\",\"desc\":\"Không/ No\"}]";
            Model.vb_contact_lenses = true;
            Model.vb_contact_lenses_note = "[{\"code\":\"WPA\",\"desc\":\"NB giữ/ With patient\"},{\"code\":\"WRE\",\"desc\":\"Thân nhân giữ/ With relative\"}]";
            //Model.vb_cash_jewelry = "[{\"code\":\"NO\",\"desc\":\"Không/ No\"}]";
            Model.vb_cash_jewelry = true;
            Model.vb_cash_jewelry_note = "[{\"code\":\"WPA\",\"desc\":\"NB giữ/ With patient\"},{\"code\":\"WRE\",\"desc\":\"Thân nhân giữ/ With relative\"},{\"code\":\"HSB\",\"desc\":\"Trong tủ đầu giường phòng/ In the hospital safety box\"}]";
        ...
        public override void SetDefaultModel()
        {
            ...
            if (Logs.Count() == 1)
            {
                ...
                Model.pain_annotation = "{\"type\":\"OHAnnotationModel\",\"version\":\"1.0\",\"dataURI\":\"data:image/png;base64,\",\"objects\":[],\"nextFootnoteIndex\":1}";
                Model.assess_date_time = DateTime.Now;
            }
        }
        public override bool LoadFormControl(ControlState state)
        {
            ...
            lbl_dis_planning.Visible
                = lbl_vb_other.Visible
                = lbl_size_note.Visible
                = lbl_ng_tube.Visible
                ...
                = lbl_allergy.Visible
                = lbl_high_risk_patient.Visible
                = lbl_diet_pre_desc.Visible
                = lbl_last_date_changed.Visible
                = lbl_medication_used.Visible
                ...
                = lbl_p_location_1.Visible
                = lbl_p_location_2.Visible
                = lbl_p_location_3.Visible
                = lbl_q_location_1.Visible
                = lbl_q_location_2.Visible
                = lbl_q_location_3.Visible
                = lbl_r_location_1.Visible
                = lbl_r_location_2.Visible
                = lbl_r_location_3.Visible
                = lbl_s_location_1.Visible
                = lbl_s_location_2.Visible
                = lbl_s_location_3.Visible
                = lbl_t_location_1.Visible
                = lbl_t_location_2.Visible
                = lbl_t_location_3.Visible
                = lbl_involvement.Visible
                = lbl_req_med_equipment.Visible
                = lbl_req_foll_care.Visible
                = lbl_suicidal_referral.Visible
                = lbl_alone_reduce_functional.Visible
                = lbl_ref_physiotherapist.Visible
                = lbl_ref_speech_therapist.Visible
                = lbl_ref_dietician.Visible
                = lbl_ref_psychologist.Visible
                = lbl_ref_other_hospital.Visible
                = lbl_support_at_home.Visible
                = lbl_req_transportation.Visible
                = lbl_stairs_climb_home.Visible
                = cb_personnel_sta.Disabled
                = cb_personnel_pat.Disabled
                = cb_physical_facilities_bel.Disabled
                = cb_physical_facilities_bat.Disabled
                = cb_physical_facilities_tel.Disabled
                = cb_physical_facilities_tep.Disabled
                = cb_physical_facilities_ncs.Disabled
                = cb_physical_facilities_mco.Disabled
                = cb_policies_and_procedure_vih.Disabled
                = cb_policies_and_procedure_pcc.Disabled
                = cb_policies_and_procedure_pun.Disabled
                = cb_policies_and_procedure_mse.Disabled
                = cb_policies_and_procedure_ppp.Disabled
                = cb_policies_and_procedure_wcn.Disabled
                = cb_inter_catheter_true.Disabled
                = cb_ind_catheter_true.Disabled
                = cb_sup_catheter_true.Disabled
                = cb_safety_precautions_lfe.Disabled
                = cb_safety_precautions_fpr.Disabled
                = cb_safety_precautions_iwb.Disabled
                = cb_safety_precautions_nsh.Disabled
                = rad_vb_dentures_false.Disabled
                = rad_vb_dentures_true.Disabled
                = cb_vb_dentures_note_wpa.Disabled
                = cb_vb_dentures_note_wre.Disabled
                = cb_vb_dentures_note_max.Disabled
                = cb_vb_dentures_note_man.Disabled
                = cb_vb_dentures_note_par.Disabled

                = cb_instructions_provided_to_pat.Disabled
                = cb_instructions_provided_to_rel.Disabled
                = cb_instructions_provided_to_oth.Disabled
                = lbl_instructions_provided_to_other.Visible
                = cb_instructions_provided_to_nap.Disabled
                = rad_vb_hearing_aid_false.Disabled
                = rad_vb_hearing_aid_true.Disabled
                = cb_vb_hearing_aid_note_wpa.Disabled
                = cb_vb_hearing_aid_note_wre.Disabled
                = cb_vb_hearing_aid_note_lef.Disabled
                = cb_vb_hearing_aid_note_rig.Disabled
                = rad_vb_eyeglasses_false.Disabled
                = rad_vb_eyeglasses_true.Disabled
                = cb_vb_eyeglasses_note_wpa.Disabled
                = cb_vb_eyeglasses_note_wre.Disabled
                = rad_vb_contact_lenses_false.Disabled
                = rad_vb_contact_lenses_true.Disabled
                = cb_vb_contact_lenses_note_wpa.Disabled
                = cb_vb_contact_lenses_note_wre.Disabled
                = rad_vb_cash_jewelry_false.Disabled
                = rad_vb_cash_jewelry_true.Disabled
                = cb_vb_cash_jewelry_note_wpa.Disabled
                = cb_vb_cash_jewelry_note_wre.Disabled
                = cb_vb_cash_jewelry_note_hsb.Disabled
            ...
            gait_trans_code_wrapper.Visible
                = txt_vb_other.Visible
                = instructions_provided_to_other_wrapper.Visible
                = involvement_wrapper.Visible
                = req_med_equipment_wrapper.Visible
                = req_foll_care_wrapper.Visible
                = suicidal_referral_wrapper.Visible
                = alone_reduce_functional_wrapper.Visible
                = ref_physiotherapist_wrapper.Visible
                = ref_speech_therapist_wrapper.Visible
                = ref_dietician_wrapper.Visible
                = ref_psychologist_wrapper.Visible
                = ref_other_hospital_wrapper.Visible
                = support_at_home_wrapper.Visible
                = req_transportation_wrapper.Visible
                = stairs_climb_home_wrapper.Visible
                = txt_dis_planning.Visible
                = txt_reassessment.Visible

                = txt_medication_used.Visible
                = p_location_1_wrapper.Visible
                = p_location_2_wrapper.Visible
                = p_location_3_wrapper.Visible
                
                = q_location_1_wrapper.Visible
                = q_location_2_wrapper.Visible
                = q_location_3_wrapper.Visible

                = r_location_1_wrapper.Visible
                = r_location_2_wrapper.Visible
                = r_location_3_wrapper.Visible

                = s_location_1_wrapper.Visible
                = s_location_2_wrapper.Visible
                = s_location_3_wrapper.Visible

                = t_location_1_wrapper.Visible
                = t_location_2_wrapper.Visible
                = t_location_3_wrapper.Visible

                = size_note_wrapper.Visible
                = last_date_changed_wrapper.Visible
                = ng_tube_wrapper.Visible
                = dtpk_arrival_date_time.Visible
                ...
                = high_risk_patient_wrapper.Visible
                = diet_code_wrapper.Visible
                = diet_pre_code_wrapper.Visible
                = sup_catheter_size_wrapper.Visible
            ...
            vb_dentures_note_wrapper.Visible = false;
            ...
            txt_bowel_elimination_other.Visible = false;
            txt_gas_presence_note.Visible = false;
            female_patient_wrapper.Visible = false;
            txt_arrived_other.Visible = false;
            substance_abuse_other_wrapper.Visible = false;
            is_high_risk_patient_true_wrapper.Visible = false;
            txt_extremities_other.Visible = false;
            instructions_provided_to_other_wrapper.Visible = false;
            contraception_other_wrapper.Visible = false;
            cough_true_wrapper.Visible = false;
            cur_in_pain_true_wrapper.Visible = false;
            using_pain_killer_true_wrapper.Visible = false;
            wounds_0_wrapper.Visible = false;
            

            prt_wounds_0_wrapper.Visible = true;
            prt_cur_in_pain_true_wrapper.Visible = false;
            prt_using_pain_killer_true_wrapper.Visible = false;
        ...
        public override void BindingDataFormEdit()
        {
            try
            {
                ...
                //residence
                BindingInputRadioButton(nameof(Model.residence_code) + "_" + Model.residence_code);
                ...
                //language
                BindingInputRadioButton(nameof(Model.language_code) + "_" + Model.language_code);
                ...
                //
                BindingInputRadioButton(nameof(Model.req_interpreter) + "_" + Model.req_interpreter);
                //WebHelpers.DataBind(form1, new HtmlInputRadioButton(), "rad_req_interpreter_" + Model.req_interpreter);
                //
                BindingInputRadioButton(nameof(Model.religion_code) + "_" + Model.religion_code);
                ...
                //
                BindingInputRadioButton(nameof(Model.spiritual_couns) + "_" + Model.spiritual_couns);
                ...
                //
                BindingInputRadioButton(nameof(Model.living_status_code) + "_" + Model.living_status_code);
                ...
                //
                BindingInputRadioButton(nameof(Model.hospital_concern_code) + "_" + Model.hospital_concern_code);
                ...
                //
                BindingInputRadioButton(nameof(Model.admit_from_code) + "_" + Model.admit_from_code);
                ...
                if(Model.arrived != null)
                {
                    BindingInputCheckBox(nameof(Model.arrived), JsonConvert.DeserializeObject<IEnumerable<EmrDicItem>>(Model.arrived), (EmrDicItem item) =>
                    {
                        if (item.code == IinaDictionary.ARRIVED_O)
                        {
                            ...
                            txt_arrived_other.Value = Model.arrived_other;
                        }
                    });
                }
                //
                ...
                //
                BindingInputRadioButton(nameof(Model.past_med_history) + "_" + Model.past_med_history);
                ...
                //
                BindingInputRadioButton(nameof(Model.past_sur_history) + "_" + Model.past_sur_history);
                ...
                //
                BindingInputCheckBox(nameof(Model.substance_abuse), WebHelpers.GetJSONToDataTable(Model.substance_abuse));
                ...
                //
                BindingInputRadioButton(nameof(Model.previous_document) + "_" + Model.previous_document);
                if (rad_previous_document_true.Checked)
                {
                    txt_previous_document_note.Value = Model.previous_document_note;
                }
                //
                BindingInputRadioButton(nameof(Model.cur_home_medication) + "_" + Model.cur_home_medication);
                //
                ...
                {
                    is_high_risk_patient_true_wrapper.Visible = true;
                ...
                if(Model.cough != null && (bool)Model.cough)
                {
                    cough_true_wrapper.Visible = true;
                    WebHelpers.DataBind(form1, new HtmlInputRadioButton(), "rad_pro_cough_" + Model.pro_cough);
                    if(Model.pro_cough != null && (bool)Model.pro_cough)
                    {
                ...
                {
                    txt_extremities_other.Visible = true;
                    txt_extremities_other.Value = Model.extremities_other;
                }
                //4.
                ...
                {
                    txt_bowel_elimination_other.Visible = true;
                    txt_bowel_elimination_other.Value = Model.bowel_elimination_other;
                }
                ...
                if(Patient.gender_e == "Female")
                {
                    ...
                    if(Model.contraception_code == IinaDictionary.CONTRACEPTION_CODE_OTH)
                    {
                        contraception_other_wrapper.Visible = true;
                ...
                if (Model.cur_in_pain != null && (bool)Model.cur_in_pain)
                {
                    cur_in_pain_true_wrapper.Visible = true;
                    ...
                    if(Model.using_pain_killer != null && (bool)Model.using_pain_killer)
                    {
                        using_pain_killer_true_wrapper.Visible = true;
                ...
                {
                    BindingInputCheckBox(nameof(Model.wounds), JsonConvert.DeserializeObject<IEnumerable<EmrDicItem>>(Model.wounds), (EmrDicItem item) =>
                    {
                        if (item.code == IinaDictionary.WOUNDS_CODE_0)
                        {
                            wounds_0_wrapper.Visible = false;
                        }
                    });
                ...
                WebHelpers.BindDateTimePicker(dtpk_arrival_date_time, Model.arrival_date_time);
                ...
                if(Model.instructions_provided_to != null)
                {
                    BindingInputCheckBox(nameof(Model.instructions_provided_to), JsonConvert.DeserializeObject<IEnumerable<EmrDicItem>>(Model.instructions_provided_to), (EmrDicItem item) =>
                    {
                        ...
                        {
                            instructions_provided_to_other_wrapper.Visible = true;
                            txt_instructions_provided_to_other.Value = Model.instructions_provided_to_other;
                        }
                    });
                }
                ...
                #region vb_dentures
                BindingInputRadioButton(nameof(Model.vb_dentures) + "_" + Model.vb_dentures);
                if (rad_vb_dentures_true.Checked)
                {
                    vb_dentures_note_wrapper.Visible = true;
                    WebHelpers.DataBind(form1, new HtmlInputCheckBox(), "cb_vb_dentures_note_", WebHelpers.GetJSONToDataTable(Model.vb_dentures_note));
                }
                #endregion

                #region vb_hearing_aid
                BindingInputRadioButton(nameof(Model.vb_hearing_aid) + "_" + Model.vb_hearing_aid);
                if (rad_vb_hearing_aid_true.Checked)
                {
                    vb_hearing_aid_wrapper.Visible = true;
                    WebHelpers.DataBind(form1, new HtmlInputCheckBox(), "cb_vb_hearing_aid_note_", WebHelpers.GetJSONToDataTable(Model.vb_hearing_aid_note));
                }

                //BindingInputRadioButton(nameof(Model.vb_hearing_aid) + "_" + Model.vb_hearing_aid);
                //if (Model.vb_hearing_aid_note != null)
                //{
                //    var vb_hearing_aid_note = JsonConvert.DeserializeObject<IEnumerable<EmrDicItem>>(Model.vb_hearing_aid_note);

                //    if (vb_hearing_aid_note.FirstOrDefault(i => i.code == IinaDictionary.VB_HEARING_AID_YES) != null)
                //    {
                //        rad_vb_hearing_aid_true.Checked = true;
                //        vb_hearing_aid_note_wrapper.Visible = true;
                //        foreach (var item in vb_hearing_aid_note)
                //        {
                //            BindingInputCheckBox(nameof(Model.vb_hearing_aid_note) + "_" + item.code);
                //        }
                //    }
                //    else if (vb_hearing_aid_note.FirstOrDefault(i => i.code == IinaDictionary.VB_HEARING_AID_NO) != null)
                //    {
                //        rad_vb_hearing_aid_false.Checked = true;
                //    }
                //}
                #endregion
                BindingInputRadioButton(nameof(Model.vb_eyeglasses) + "_" + Model.vb_eyeglasses);
                if (rad_vb_eyeglasses_true.Checked)
                {
                    vb_eyeglasses_wrapper.Visible = true;
                    WebHelpers.DataBind(form1, new HtmlInputCheckBox(), "cb_vb_eyeglasses_note_", WebHelpers.GetJSONToDataTable(Model.vb_eyeglasses_note));
                }
                //#region vb_eyeglasses
                //if(Model.vb_eyeglasses_note != null)
                //{
                //    var vb_eyeglasses = JsonConvert.DeserializeObject<IEnumerable<EmrDicItem>>(Model.vb_eyeglasses_note);

                //    if (rad_vb_eyeglasses_yes.Checked)
                //    {
                ...
                //}
                //#endregion
                BindingInputRadioButton(nameof(Model.vb_contact_lenses) + "_" + Model.vb_contact_lenses);
                if (rad_vb_contact_lenses_true.Checked)
                {
                    vb_contact_lenses_wrapper.Visible = true;
                    WebHelpers.DataBind(form1, new HtmlInputCheckBox(), "cb_vb_contact_lenses_note_", WebHelpers.GetJSONToDataTable(Model.vb_contact_lenses_note));
                }
                ...
                //}
                //#endregion
                BindingInputRadioButton(nameof(Model.vb_cash_jewelry) + "_" + Model.vb_cash_jewelry);
                if (rad_vb_cash_jewelry_true.Checked)
                {
                    vb_cash_jewelry_wrapper.Visible = true;
                    WebHelpers.DataBind(form1, new HtmlInputCheckBox(), "cb_vb_cash_jewelry_note_", WebHelpers.GetJSONToDataTable(Model.vb_cash_jewelry_note));
                }
        ...
        public override void BindingDataFormView()
        {
            try
            {
                ...
                lbl_contact_name.Text = Patient.contact_name_l;
                lbl_contact_relationship.Text = Patient.relationship_type_rcd;
                ...
                //B
                lbl_admit_from_desc.Text = Model.admit_from_desc + (Model.admit_from_code == "OTH" ? ": " + WebHelpers.FormatString(Model.admit_from_other) : "");
                ...
                if(arrived != null)
                {
                    foreach (DataRow dr in arrived.Rows)
                    {
                        lbl_arrived.Text += $"{dr["desc"]}";
                        if (Convert.ToString(dr["code"]) == IinaDictionary.ARRIVED_O)
                        {
                            lbl_arrived.Text += $": {Model.arrived_other}";
                        }
                        lbl_arrived.Text += "<br/>";
                    }
                }
                ...
                lbl_past_med_history.Text = WebHelpers.FormatString(WebHelpers.GetBool(Model.past_med_history, "Có, ghi rõ/ Yes, specify: " + Model.past_med_history_note));
                lbl_past_sur_history.Text = WebHelpers.FormatString(WebHelpers.GetBool(Model.past_sur_history, "Có, ghi rõ/ Yes, specify: " + Model.past_sur_history_note));
                ...
                {
                    foreach (DataRow dr in substance_abuse.Rows)
                    {
                        lbl_substance_abuse.Text += $"{dr["desc"]}";
                        if (Convert.ToString(dr["code"]) == IinaDictionary.SUBSTANCE_ABUSE_OTH)
                        {
                            lbl_substance_abuse.Text += $": {Model.substance_abuse_other}";
                        }
                        lbl_substance_abuse.Text += "<br/>";
                    }
                }
                ...
                lbl_is_high_risk_patient.Text = WebHelpers.GetBool(Model.is_high_risk_patient, "Có, cụ thể/ Yes, specify");
                ...
                if (extremities != null)
                {
                    foreach (DataRow dr in extremities.Rows)
                    {
                        lbl_extremities.Text += $"{dr["desc"]}";
                        if (Convert.ToString(dr["code"]) == IinaDictionary.EXTREMITIES_CODE_OT)
                        {
                            lbl_extremities.Text += $": {Model.extremities_other}";
                        }
                        lbl_extremities.Text += "<br/>";
                    }
                }
                ...
                {
                    foreach (DataRow dr in mental_status.Rows)
                    {
                        lbl_mental_status.Text += $"{dr["desc"]}";
                        if (Convert.ToString(dr["code"]) == IinaDictionary.MENTAL_STATUS_CODE_OTH)
                        {
                            lbl_mental_status.Text += $": {Model.mental_status_other}";
                        }
                        lbl_mental_status.Text += "<br/>";
                    }
                }
                ...
                if(Model.diet_code == IinaDictionary.DIET_CODE_OTH)
                {
                    lbl_diet_desc.Text += ": " + Model.diet_other;
                }
                ...
                if(Model.bowel_elimination_code == IinaDictionary.BOWEL_ELIMINATION_CODE_OTH)
                {
                    lbl_bowel_elimination_desc.Text += ": " + Model.bowel_elimination_other;
                }
                ...
                if(Model.gas_presence_code == IinaDictionary.GAS_PRESENCE_CODE_S)
                {
                    lbl_gas_presence_desc.Text += ": " + Model.gas_presence_note;
                }
                //6
                ...
                if (Model.inter_catheter != null) { cb_inter_catheter_true.Checked = (bool)Model.inter_catheter; }
                if (Model.ind_catheter != null) { cb_ind_catheter_true.Checked = (bool)Model.ind_catheter; }
                ...
                if (Patient.gender_e == "Female")
                {
                    ...
                    lbl_contraception_code.Text = WebHelpers.FormatString(Model.contraception_desc);
                    if(Model.contraception_code == IinaDictionary.CONTRACEPTION_CODE_OTH)
                    {
                        lbl_contraception_code.Text += ": " + WebHelpers.FormatString(Model.contraception_other);
                    }
                }
                //8
                ...
                if (wounds != null)
                {
                    foreach (DataRow dr in wounds.Rows)
                    {
                        lbl_wounds.Text += $"{dr["desc"]}";
                        if (Convert.ToString(dr["code"]) == IinaDictionary.WOUNDS_CODE_0)
                        {
                            wounds_0_wrapper.Visible = false;
                            lbl_wounds.Text += $": {Model.mental_status_other}";
                        }
                        lbl_wounds.Text += "<br/>";
                    }
                }
                ...
                lbl_alone_reduce_functional.Text = WebHelpers.FormatString(WebHelpers.GetBool(Model.alone_reduce_functional));
                ...
                lbl_reassessment.Text = WebHelpers.FormatString(Model.reassessment);
                //F
                //lbl_dis_management.Text = WebHelpers.FormatString(Model.dis_management);
                lbl_arrival_date_time.Text = WebHelpers.FormatString(WebHelpers.FormatDateTime(Model.arrival_date_time, "dd-MMM-yyyy HH:mm"));
                ...
                if (Model.instructions_provided_to != null)
                {
                    BindingInputCheckBox(nameof(Model.instructions_provided_to), JsonConvert.DeserializeObject<IEnumerable<EmrDicItem>>(Model.instructions_provided_to), (EmrDicItem item) =>
                    {
                        if (item.code == IinaDictionary.INSTRUCTIONS_PROVIDED_TO_OTH)
                        {
                            lbl_instructions_provided_to_other.Text = Model.instructions_provided_to_other;
                        }
                    });
                }
                ...
                lbl_vb_other.Text = Model.vb_other;
        ...
        public override void BindingDataFormPrint()
        {
            ...
            prt_date_of_admission.Text = WebHelpers.FormatDateTime(Model.arrival_date_time, "dd/MM/yyyy");
            prt_time_of_admission.Text = WebHelpers.FormatDateTime(Model.arrival_date_time, "HH:mm");
            ...
            BindingLabel(nameof(Model.residence_code) + "_" + Model.residence_code, "☑");
            if (Model.residence_code == IinaDictionary.RESIDENCE_CODE_OTH)
            {
                prt_residence_other.Text = Model.residence_other;
            }

            BindingLabel(nameof(Model.language_code) + "_" + Model.language_code, "☑");
            if (Model.language_code == IinaDictionary.LANGUAGE_CODE_OTH)
            {
                prt_language_other.Text = Model.language_other;
            }

            BindingLabel(nameof(Model.req_interpreter) + "_" + Model.req_interpreter, "☑");

            BindingLabel(nameof(Model.religion_code) + "_" + Model.religion_code, "☑");
            if (Model.religion_code == IinaDictionary.RELIGION_CODE_OTH)
            {
                prt_religion_other.Text = Model.religion_other;
            }

            BindingLabel(nameof(Model.spiritual_couns) + "_" + Model.spiritual_couns, "☑");

            prt_occupation.Text = Model.occupation;

            BindingLabel(nameof(Model.living_status_code) + "_" + Model.living_status_code, "☑");
            if (Model.living_status_code == IinaDictionary.LIVING_STATUS_CODE_OTH)
            {
                prt_living_status_note.Text = Model.living_status_note;
            }

            BindingLabel(nameof(Model.hospital_concern_code) + "_" + Model.hospital_concern_code, "☑");
            if (Model.hospital_concern_code == IinaDictionary.HOSPITAL_CONCERN_CODE_OTH)
            {
            ...
            BindingLabel(nameof(Model.admit_from_code) + "_" + Model.admit_from_code, "☑");
            if (Model.admit_from_code == IinaDictionary.ADMIT_FROM_CODE_OTH)
            {
            ...
            if (arrived != null)
            {
                foreach (DataRow row in arrived.Rows)
                {
                    ...
                    BindingLabel(nameof(Model.arrived) + "_" + code, "☑");
                    if(code == IinaDictionary.ARRIVED_O)
                    {
                        prt_arrived_other.Text = Model.arrived_other;
                    }
                }
            ...
            BindingLabel(nameof(Model.previous_admission) + "_" + !string.IsNullOrEmpty(Model.previous_admission), "☑");
            if(prt_previous_admission_true.Text == "☑")
            {
                prt_previous_admission.Text = Model.previous_admission;
            }

            BindingLabel(nameof(Model.past_med_history) + "_" + Model.past_med_history, "☑");
            if (prt_past_med_history_true.Text == "☑")
            {
                prt_past_med_history_note.Text = Model.past_med_history_note;
            }

            BindingLabel(nameof(Model.past_sur_history) + "_" + Model.past_sur_history, "☑");
            if (prt_past_sur_history_true.Text == "☑")
            {
            ...
            if (substance_abuse != null)
            {
                ...
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.substance_abuse) + "_" + code, "☑");
                    if(code == IinaDictionary.SUBSTANCE_ABUSE_OTH)
                    {
            ...
            BindingLabel(nameof(Model.previous_document) + "_" + Model.previous_document, "☑", () =>
            {
                if ((bool)Model.previous_document)
                {
                    prt_previous_document_note.Text = Model.previous_document_note;
                }
            });

            BindingLabel(nameof(Model.cur_home_medication) + "_" + Model.cur_home_medication, "☑");

            BindingLabel(nameof(Model.allergy) + "_" + Model.allergy, "☑", () =>
            {
                if ((bool)Model.allergy)
                {
                    prt_allergy_note.Text = Model.allergy_note;
                }
            });

            BindingLabel(nameof(Model.is_high_risk_patient) + "_" + Model.is_high_risk_patient, "☑");
            ...
            if (high_risk_patient != null)
            {
                ...
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.high_risk_patient) + "_" + code, "☑");
                }
            }
                ...
                if (respiratory_system != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.respiratory_system) + "_" + code, "☑");
                    }
                }

            BindingLabel(nameof(Model.cough) + "_" + Model.cough, "☑");

            BindingLabel(nameof(Model.pro_cough) + "_" + Model.pro_cough, "☑", () =>
            {
                if ((bool)Model.pro_cough)
                {
            ...
            BindingLabel(nameof(Model.pulse_code) + "_" + Model.pulse_code, "☑");
                ...
                if (presence != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.presence) + "_" + code, "☑");
                    }
                }
                ...
                if (extremities != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.extremities) + "_" + code, "☑");
                        if(code == IinaDictionary.EXTREMITIES_CODE_OT)
                        {
                            prt_extremities_other.Text = Model.extremities_other;
                        }
                    }
                }
                ...
                if (oriented != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.oriented) + "_" + code, "☑");
                    }
                }
                ...
                if (mental_status != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.mental_status) + "_" + code, "☑", () =>
                        {
                            if (code == IinaDictionary.MENTAL_STATUS_CODE_OTH)
                            {
                ...
                BindingLabel(nameof(Model.hearing_code) + "_" + Model.hearing_code, "☑");

            BindingLabel(nameof(Model.vision_code) + "_" + Model.vision_code, "☑", () =>
            {
                if(Model.vision_code == IinaDictionary.VISION_CODE_OTH)
                {
                    prt_vision_other.Text = Model.vision_other;
                }
            });

            BindingLabel(nameof(Model.speech_code) + "_" + Model.speech_code, "☑");

            #endregion

            #region 5. Hệ tiêu hóa/ Gastrointestinal system
            BindingLabel(nameof(Model.diet_code) + "_" + Model.diet_code, "☑", () =>
            {
                if (Model.diet_code == IinaDictionary.DIET_CODE_OTH)
                {
            ...
            BindingLabel(nameof(Model.diet_pre_code) + "_" + Model.diet_pre_code, "☑");

            BindingLabel(nameof(Model.ng_tube) + "_" + Model.ng_tube, "☑");

            BindingLabel(nameof(Model.gastrostomy) + "_" + Model.gastrostomy, "☑");

            BindingLabel(nameof(Model.size) + "_" + Model.size, "☑");
            ...
            BindingLabel(nameof(Model.bowel_elimination_code) + "_" + Model.bowel_elimination_code, "☑");
            if(prt_bowel_elimination_code_oth.Text == "☑")
            {
                prt_bowel_elimination_other.Text = Model.bowel_elimination_other;
            }

            BindingLabel(nameof(Model.stool_consistency_code) + "_" + Model.stool_consistency_code, "☑");

            BindingLabel(nameof(Model.gas_presence_code) + "_" + Model.gas_presence_code, "☑", () =>
            {
                if(Model.gas_presence_code == IinaDictionary.GAS_PRESENCE_CODE_S)
                {
                    prt_gas_presence_note.Text = Model.gas_presence_note;
                }
            });
            ...
            //    prt_total_nutri_score.Text = Model.total_nutri_score;
                ...
                if (urination != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.urination) + "_" + code, "☑");
                    }
                }

            BindingLabel(nameof(Model.inter_catheter) + "_" + Model.inter_catheter, "☑", () =>
            {
                if ((bool)Model.inter_catheter)
                {
                    prt_inter_catheter_note.Text = Model.inter_catheter_note;
                }
            });

            BindingLabel(nameof(Model.ind_catheter) + "_" + Model.ind_catheter, "☑", () =>
            {
                if ((bool)Model.ind_catheter)
                {
                    prt_inter_catheter_note.Text = Model.inter_catheter_note;
                }
            });
            ...
            BindingLabel(nameof(Model.sup_catheter) + "_" + Model.sup_catheter, "☑");
            ...
            if (Patient.gender_e == "Female")
            {
                prt_female_patient_wrapper.Visible = true;

                BindingLabel(nameof(Model.menstruation_code) + "_" + Model.menstruation_code, "☑");
                prt_cycle_day.Text = Model.cycle_day;

                prt_last_mens_period.Text = Model.last_mens_period;
                ...
                BindingLabel(nameof(Model.not_pregnancy) + "_" + Model.not_pregnancy, "☑");

                BindingLabel(nameof(Model.pre_pregnancy) + "_" + Model.pre_pregnancy, "☑");

                prt_para.Text = Model.para;
                
                BindingLabel(nameof(Model.cur_pregnancy) + "_" + Model.cur_pregnancy, "☑");
                prt_pregnancy_week.Text = Model.pregnancy_week;

                BindingLabel(nameof(Model.contraception_code) + "_" + Model.contraception_code, "☑", () =>
                {
                    if(Model.contraception_code == IinaDictionary.CONTRACEPTION_CODE_OTH)
                    {
                ...
                #region 7. Hệ cơ - xương khớp/ Musculoskeletal system
                ...
                if (mus_history != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.mus_history) + "_" + code, "☑");
                    }
                }

            BindingLabel(nameof(Model.paralysis) + "_" + Model.paralysis, "☑");
            BindingLabel(nameof(Model.amputation) + "_" + Model.amputation, "☑");
            BindingLabel(nameof(Model.contracture) + "_" + Model.contracture, "☑");
            BindingLabel(nameof(Model.prosthesis) + "_" + Model.prosthesis, "☑");
            ...
            BindingLabel(nameof(Model.cur_in_pain) + "_" + Model.cur_in_pain, "☑");
            if(prt_cur_in_pain_true.Text == "☑")
            {
                prt_cur_in_pain_true_wrapper.Visible = true;
            ...
            BindingLabel(nameof(Model.using_pain_killer) + "_" + Model.using_pain_killer, "☑");
                if(prt_using_pain_killer_true.Text == "☑")
                {
                    prt_using_pain_killer_true_wrapper.Visible = true;
                ...
                #region 9. Da & Nguy cơ loét tỳ đè/ Skin & Pressure Sore Risk
                ...
                if (condition != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.condition) + "_" + code, "☑");
                ...
                if (wounds != null)
                {
                    ...
                    {
                        string code = Convert.ToString(row["code"]);
                        BindingLabel(nameof(Model.wounds) + "_" + code, "☑");
                        if(code == IinaDictionary.WOUNDS_CODE_0)
                        {
                            prt_wounds_0_wrapper.Visible = false;
                        }
                    }
                }
                ...
                prt_fr_total_score.Text = Convert.ToString(Model.fr_total_score);

            if(Model.fr_total_score != null) 
            {
                if(int.TryParse(Convert.ToString(Model.fr_total_score), out int fr_total_score))
                {
                    if(fr_total_score >= 45)
                    {
                        prt_fr_total_score_h.Text = "☑";
                    }
                    else if(fr_total_score >= 25)
                    {
                        prt_fr_total_score_m.Text = "☑";
                    }
                    else if(fr_total_score >= 0)
                    {
                        prt_fr_total_score_l.Text = "☑";
                    }
                }
            }
            
            BindingLabel(nameof(Model.pres_sore_risk_code) + "_" + Model.pres_sore_risk_code, "☑");
            BindingLabel(nameof(Model.bathing_code) + "_" + Model.bathing_code, "☑");
            BindingLabel(nameof(Model.oral_care_code) + "_" + Model.oral_care_code, "☑");
            prt_oral_care_note.Text = Model.oral_care_note;
            BindingLabel(nameof(Model.dentures_code) + "_" + Model.dentures_code, "☑");
            BindingLabel(nameof(Model.toilet_use_code) + "_" + Model.toilet_use_code, "☑");
            BindingLabel(nameof(Model.dressing_code) + "_" + Model.dressing_code, "☑");
            BindingLabel(nameof(Model.eating_code) + "_" + Model.eating_code, "☑");
            BindingLabel(nameof(Model.turning_bed_code) + "_" + Model.turning_bed_code, "☑");
            BindingLabel(nameof(Model.ambulation_code) + "_" + Model.ambulation_code, "☑");
            if (rad_ambulation_code_na.Checked)
            {
                prt_ambulation_note.Text = Model.ambulation_note;
            }
            BindingLabel(nameof(Model.sleep_code) + "_" + Model.sleep_code, "☑");
            BindingLabel(nameof(Model.medication_used) + "_" + Model.medication_used, "☑");
            BindingLabel(nameof(Model.fall_history_code) + "_" + Model.fall_history_code, "☑");
            BindingLabel(nameof(Model.secon_diagnosis_code) + "_" + Model.secon_diagnosis_code, "☑");
            BindingLabel(nameof(Model.ambula_aids_code) + "_" + Model.ambula_aids_code, "☑");
            BindingLabel(nameof(Model.intra_therapy_code) + "_" + Model.intra_therapy_code, "☑");
            BindingLabel(nameof(Model.gait_trans_code) + "_" + Model.gait_trans_code, "☑");
            BindingLabel(nameof(Model.fr_mental_status_code) + "_" + Model.fr_mental_status_code, "☑");

            //D
            BindingLabel(nameof(Model.involvement) + "_" + Model.involvement, "☑");
            BindingLabel(nameof(Model.req_med_equipment) + "_" + Model.req_med_equipment, "☑");
            BindingLabel(nameof(Model.req_foll_care) + "_" + Model.req_foll_care, "☑");
            BindingLabel(nameof(Model.suicidal_referral) + "_" + Model.suicidal_referral, "☑");
            BindingLabel(nameof(Model.alone_reduce_functional) + "_" + Model.alone_reduce_functional, "☑");
            BindingLabel(nameof(Model.ref_physiotherapist) + "_" + Model.ref_physiotherapist, "☑");
            BindingLabel(nameof(Model.ref_speech_therapist) + "_" + Model.ref_speech_therapist, "☑");
            BindingLabel(nameof(Model.ref_dietician) + "_" + Model.ref_dietician, "☑");
            BindingLabel(nameof(Model.ref_psychologist) + "_" + Model.ref_psychologist, "☑");
            BindingLabel(nameof(Model.ref_other_hospital) + "_" + Model.ref_other_hospital, "☑");
            BindingLabel(nameof(Model.support_at_home) + "_" + Model.support_at_home, "☑");
            BindingLabel(nameof(Model.req_transportation) + "_" + Model.req_transportation, "☑");
            BindingLabel(nameof(Model.stairs_climb_home) + "_" + Model.stairs_climb_home, "☑");
            ...
            prt_reassessment.Text = Model.reassessment;
            

            #region V.	HƯỚNG DẪN NGƯỜI BỆNH VỀ NHỮNG TIỆN NGHI TRONG PHÒNG VÀ CÁC DỊCH VỤ/ PATIENT GUIDES TO ROOM FACILITIES AND SERVICES
            BindingLabel(nameof(Model.instructions_provided_to) + "_" + Model.instructions_provided_to, "☑");

            DataTable instructions_provided_to = WebHelpers.GetJSONToDataTable(Model.instructions_provided_to);
            if (instructions_provided_to != null)
            {
                foreach (DataRow row in instructions_provided_to.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.instructions_provided_to) + "_" + code, "☑");
                    if(code == IinaDictionary.INSTRUCTIONS_PROVIDED_TO_OTH)
                    {
                        prt_instructions_provided_to_other.Text = Model.instructions_provided_to_other;
                    }
                }
            }

            DataTable personnel = WebHelpers.GetJSONToDataTable(Model.personnel);
            if(personnel != null)
            {
                foreach (DataRow row in personnel.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.personnel) + "_" + code, "☑");
                }
            }

            DataTable physical_facilities = WebHelpers.GetJSONToDataTable(Model.physical_facilities);
            if (physical_facilities != null)
            {
                foreach (DataRow row in physical_facilities.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.physical_facilities) + "_" + code, "☑");
                }
            }

            DataTable policies_and_procedure = WebHelpers.GetJSONToDataTable(Model.policies_and_procedure);
            if (policies_and_procedure != null)
            {
                foreach (DataRow row in policies_and_procedure.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.policies_and_procedure) + "_" + code, "☑");
                }
            }

            DataTable safety_precautions = WebHelpers.GetJSONToDataTable(Model.safety_precautions);
            if (safety_precautions != null)
            {
                foreach (DataRow row in safety_precautions.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.safety_precautions) + "_" + code, "☑");
                }
            }

            BindingLabel(nameof(Model.vb_dentures) + "_" + Model.vb_dentures, "☑");
            DataTable vb_dentures_note = WebHelpers.GetJSONToDataTable(Model.vb_dentures_note);
            if (vb_dentures_note != null)
            {
                foreach (DataRow row in vb_dentures_note.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.vb_dentures_note) + "_" + code, "☑");
                }
            }

            BindingLabel(nameof(Model.vb_hearing_aid) + "_" + Model.vb_hearing_aid, "☑");
            DataTable vb_hearing_aid_note = WebHelpers.GetJSONToDataTable(Model.vb_hearing_aid_note);
            if (vb_hearing_aid_note != null)
            {
                foreach (DataRow row in vb_hearing_aid_note.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.vb_hearing_aid_note) + "_" + code, "☑");
                }
            }

            BindingLabel(nameof(Model.vb_eyeglasses) + "_" + Model.vb_eyeglasses, "☑");
            DataTable vb_eyeglasses_note = WebHelpers.GetJSONToDataTable(Model.vb_eyeglasses_note);
            if (vb_eyeglasses_note != null)
            {
                foreach (DataRow row in vb_eyeglasses_note.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.vb_eyeglasses_note) + "_" + code, "☑");
                }
            }

            BindingLabel(nameof(Model.vb_contact_lenses) + "_" + Model.vb_contact_lenses, "☑");
            DataTable vb_contact_lenses_note = WebHelpers.GetJSONToDataTable(Model.vb_contact_lenses_note);
            if (vb_contact_lenses_note != null)
            {
                foreach (DataRow row in vb_contact_lenses_note.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.vb_contact_lenses_note) + "_" + code, "☑");
                }
            }

            BindingLabel(nameof(Model.vb_cash_jewelry) + "_" + Model.vb_cash_jewelry, "☑");
            DataTable vb_cash_jewelry_note = WebHelpers.GetJSONToDataTable(Model.vb_cash_jewelry_note);
            if (vb_cash_jewelry_note != null)
            {
                foreach (DataRow row in vb_cash_jewelry_note.Rows)
                {
                    string code = Convert.ToString(row["code"]);
                    BindingLabel(nameof(Model.vb_cash_jewelry_note) + "_" + code, "☑");
                }
            }

            prt_vb_other.Text = Model.vb_other;
        ...
        {
            Model.arrival_date_time = DataHelpers.ConvertSQLDateTime(dtpk_arrival_date_time.SelectedDate);
            Model.assess_date_time = DataHelpers.ConvertSQLDateTime(dtpk_assess_date_time.SelectedDate);

            #region I. THÔNG TIN TỔNG QUÁT VỀ NGƯỜI BỆNH/ GENERAL PATIENT INFORMATION
            Model.residence_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.residence_code)}_", IinaDictionary.RESIDENCE_CODE);
            ...
            //
            Model.language_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.language_code)}_", IinaDictionary.LANGUAGE_CODE);
            ...
            //
            Model.req_interpreter = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.req_interpreter)}_");
            //
            Model.religion_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.religion_code)}_", IinaDictionary.RELIGION_CODE);
            ...
            //
            Model.spiritual_couns = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.spiritual_couns)}_");
            //
            Model.occupation = txt_occupation.Value;
            //
            Model.living_status_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.living_status_code)}_", IinaDictionary.LIVING_STATUS_CODE);
            ...
            //
            Model.hospital_concern_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.hospital_concern_code)}_", IinaDictionary.HOSPITAL_CONCERN_CODE);
            ...
            #region II. BỆNH SỬ/ MEDICAL HISTORY
            Model.admit_from_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.admit_from_code)}_", IinaDictionary.ADMIT_FROM_CODE);
            Model.admit_from_desc = WebHelpers.GetDicDesc(Model.admit_from_code, IinaDictionary.ADMIT_FROM_CODE);
            if (Model.admit_from_code == IinaDictionary.ADMIT_FROM_CODE_OTH)
            {
                Model.admit_from_other = txt_admit_from_other.Value;
            }

            Model.arrived = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.arrived)}_", IinaDictionary.ARRIVED);
            if (cb_arrived_o.Checked)
            {
                Model.arrived_other = txt_arrived_other.Value;
            }

            Model.admission_reason = txt_admission_reason.Value;

            Model.past_med_history = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.past_med_history)}_");
            if (rad_past_med_history_true.Checked)
            {
                Model.past_med_history_note = txt_past_med_history_note.Value;
            }

            Model.past_sur_history = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.past_sur_history)}_");
            if (rad_past_sur_history_true.Checked)
            {
                Model.past_sur_history_note = txt_past_sur_history_note.Value;
            }

            Model.substance_abuse = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.substance_abuse)}_", IinaDictionary.SUBSTANCE_ABUSE);
            if (cb_substance_abuse_oth.Checked)
            {
                Model.substance_abuse_other = txt_substance_abuse_other.Value;
            }

            Model.previous_document = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.previous_document)}_");
            if(rad_previous_document_true.Checked)
            {
                Model.previous_document_note = txt_previous_document_note.Value;
            }

            Model.cur_home_medication = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.cur_home_medication)}_");

            Model.allergy = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.allergy)}_");
            if (rad_allergy_true.Checked)
            {
                Model.allergy_note = txt_allergy_note.Value;
            }

            Model.is_high_risk_patient = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.is_high_risk_patient)}_");

            if (rad_is_high_risk_patient_true.Checked)
            {
                Model.high_risk_patient = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.high_risk_patient)}_", IinaDictionary.HIGH_RISK_PATIENT_CODE);
            }
            #endregion
            ...
            Model.respiratory_system = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.respiratory_system)}_", IinaDictionary.RESPIRATORY_SYSTEM_CODE);
            Model.cough = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.cough)}_");
            if (rad_cough_true.Checked)
            {
                Model.pro_cough = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.pro_cough)}_");
                if(rad_pro_cough_true.Checked)
                {
                    Model.pro_cough_note = txt_pro_cough_note.Value;
                }
            }

            Model.pulse_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.pulse_code)}_", IinaDictionary.PULSE_CODE);
            Model.pulse_desc = WebHelpers.GetDicDesc(Model.pulse_code, IinaDictionary.PULSE_CODE);

            Model.presence = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.presence)}_", IinaDictionary.PRESENCE_CODE);

            Model.extremities = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.extremities)}_", IinaDictionary.EXTREMITIES_CODE);
            if (cb_extremities_ot.Checked)
            {
                Model.extremities_other = txt_extremities_other.Value;
            }

            Model.oriented = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.oriented)}_", IinaDictionary.ORIENTED_CODE);
            Model.mental_status = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.mental_status)}_", IinaDictionary.MENTAL_STATUS_CODE);
            if(cb_mental_status_oth.Checked)
            {
                Model.mental_status_other = txt_mental_status_other.Value;
            }

            Model.hearing_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.hearing_code)}_", IinaDictionary.HEARING_CODE);
            Model.hearing_desc = WebHelpers.GetDicDesc(Model.hearing_code, IinaDictionary.HEARING_CODE);

            Model.vision_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.vision_code)}_", IinaDictionary.VISION_CODE);
            Model.vision_desc = WebHelpers.GetDicDesc(Model.vision_code, IinaDictionary.VISION_CODE);
            if (rad_vision_code_oth.Checked)
            {
                Model.vision_other = txt_vision_other.Value;
            }

            Model.speech_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.speech_code)}_", IinaDictionary.SPEECH_CODE);
            Model.speech_desc = WebHelpers.GetDicDesc(Model.speech_code, IinaDictionary.SPEECH_CODE);

            //
            Model.diet_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.diet_code)}_", IinaDictionary.DIET_CODE);
            Model.diet_desc = WebHelpers.GetDicDesc(Model.diet_code, IinaDictionary.DIET_CODE);
            if (rad_diet_code_oth.Checked)
            {
                Model.diet_other = txt_diet_other.Value;
            }

            Model.diet_pre_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.diet_pre_code)}_", IinaDictionary.DIET_PRE_CODE);
            Model.diet_pre_desc = WebHelpers.GetDicDesc(Model.diet_pre_code, IinaDictionary.DIET_PRE_CODE);

            Model.ng_tube = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.ng_tube)}_");
            Model.gastrostomy = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.gastrostomy)}_", true);
            Model.size = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.size)}_", true);
            ...
            Model.bowel_elimination_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.bowel_elimination_code)}_", IinaDictionary.BOWEL_ELIMINATION_CODE);
            Model.bowel_elimination_desc = WebHelpers.GetDicDesc(Model.bowel_elimination_code, IinaDictionary.BOWEL_ELIMINATION_CODE);
            if (rad_bowel_elimination_code_oth.Checked)
            {
                Model.bowel_elimination_other = txt_bowel_elimination_other.Value;
            }

            Model.stool_consistency_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.stool_consistency_code)}_", IinaDictionary.STOOL_CONSISTENCY_CODE);
            if (Model.stool_consistency_code != null)
            {
                Model.stool_consistency_desc = IinaDictionary.STOOL_CONSISTENCY_CODE[Model.stool_consistency_code];
            }

            Model.gas_presence_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.gas_presence_code)}_", IinaDictionary.GAS_PRESENCE_CODE);
            Model.gas_presence_desc = WebHelpers.GetDicDesc(Model.gas_presence_code, IinaDictionary.GAS_PRESENCE_CODE);
            if (rad_gas_presence_code_s.Checked)
            {
                Model.gas_presence_note = txt_gas_presence_note.Value;
            }

            //6. Hệ tiết niệu sinh dục/ Genitourinary system
            Model.urination = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.urination)}_", IinaDictionary.URINATION_CODE);
            Model.inter_catheter = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.inter_catheter)}_", true);
            Model.inter_catheter_note = txt_inter_catheter_note.Value;

            Model.ind_catheter = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.ind_catheter)}_", true);
            ...
            Model.sup_catheter = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.sup_catheter)}_", true);
            ...
            Model.menstruation_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.menstruation_code)}_", IinaDictionary.MENSTRUATION_CODE);
            ...
            Model.not_pregnancy = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.not_pregnancy)}_", true);
            Model.pre_pregnancy = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.pre_pregnancy)}_", true);
            Model.para = txt_para.Value;
            Model.cur_pregnancy = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.cur_pregnancy)}_", true);
            Model.pregnancy_week = txt_pregnancy_week.Value;

            Model.contraception_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.contraception_code)}_", IinaDictionary.CONTRACEPTION_CODE);
            Model.contraception_desc = WebHelpers.GetDicDesc(Model.contraception_code, IinaDictionary.CONTRACEPTION_CODE);
            if (rad_contraception_code_oth.Checked)
            {
                Model.contraception_other = txt_contraception_other.Value;
            }

            //7. Hệ cơ – xương khớp/ Musculoskeletal system
            Model.mus_history = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.mus_history)}_", IinaDictionary.MUS_HISTORY);

            Model.paralysis = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.paralysis)}_", true);
            Model.paralysis_note = txt_paralysis_note.Value;

            Model.amputation = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.amputation)}_", true);
            Model.amputation_note = txt_amputation_note.Value;

            Model.contracture = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.contracture)}_", true);
            Model.contracture_note = txt_contracture_note.Value;

            Model.prosthesis = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.prosthesis)}_", true);
            Model.prosthesis_note = txt_prosthesis_note.Value;

            //8. Đánh giá đau/ Pain assessment
            Model.cur_in_pain = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.cur_in_pain)}_");
            ...
            Model.using_pain_killer = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.using_pain_killer)}_");
            Model.pain_killer_name = txt_pain_killer_name.Value;
            Model.pa_comment = txt_pa_comment.Value;

            //9. Da & Nguy cơ loét tỳ đè/ Skin & Pressure ulcer risk
            Model.condition = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.condition)}_", IinaDictionary.CONDITION_CODE);
            Model.wounds = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"cb_{nameof(Model.wounds)}_", IinaDictionary.WOUNDS_CODE);
            Model.skin_anno = WebHelpers.GetDataGridView(grid_skin_anno, IinaDictionary.SKIN_ANNO);

            Model.sensory_code = Request.Form.Get($"select_{Model.sensory_code}");
            Model.sensory_desc = WebHelpers.GetDicDesc(Model.sensory_code, IinaDictionary.SENSORY_CODE);

            Model.moisture_code = Request.Form.Get($"select_{Model.moisture_code}");
            Model.moisture_desc = WebHelpers.GetDicDesc(Model.moisture_code, IinaDictionary.MOISTURE_CODE);

            Model.activity_code = Request.Form.Get($"select_{Model.activity_code}");
            Model.activity_desc = WebHelpers.GetDicDesc(Model.activity_code, IinaDictionary.ACTIVITY_CODE);

            Model.mobility_code = Request.Form.Get($"select_{Model.mobility_code}");
            Model.mobility_desc = WebHelpers.GetDicDesc(Model.mobility_code, IinaDictionary.MOBILITY_CODE);

            Model.nutrition_code = Request.Form.Get($"select_{Model.nutrition_code}");
            Model.nutrition_desc = WebHelpers.GetDicDesc(Model.nutrition_code, IinaDictionary.NUTRITION_CODE);

            Model.friction_code = Request.Form.Get($"select_{Model.friction_code}");
            ...
            Model.bathing_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.bathing_code)}_", IinaDictionary.BATHING_CODE);
            Model.bathing_desc = WebHelpers.GetDicDesc(Model.bathing_code, IinaDictionary.BATHING_CODE);

            Model.oral_care_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.oral_care_code)}_", IinaDictionary.ORAL_CARE_CODE);
            ...
            Model.dentures_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.dentures_code)}_", IinaDictionary.DENTURES_CODE);
            Model.dentures_desc = WebHelpers.GetDicDesc(Model.dentures_code, IinaDictionary.DENTURES_CODE);

            Model.toilet_use_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.toilet_use_code)}_", IinaDictionary.TOILET_USE_CODE);
            Model.toilet_use_desc = WebHelpers.GetDicDesc(Model.toilet_use_code, IinaDictionary.TOILET_USE_CODE);

            Model.dressing_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.dressing_code)}_", IinaDictionary.DRESSING_CODE);
            Model.dressing_desc = WebHelpers.GetDicDesc(Model.dressing_code, IinaDictionary.DRESSING_CODE);

            Model.eating_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.eating_code)}_", IinaDictionary.EATING_CODE);
            Model.eating_desc = WebHelpers.GetDicDesc(Model.eating_code, IinaDictionary.EATING_CODE);

            Model.turning_bed_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.turning_bed_code)}_", IinaDictionary.TURNING_BED_CODE);
            Model.turning_bed_desc = WebHelpers.GetDicDesc(Model.turning_bed_code, IinaDictionary.TURNING_BED_CODE);

            Model.ambulation_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.ambulation_code)}_", IinaDictionary.AMBULATION_CODE);
            ...
            Model.sleep_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.sleep_code)}_", IinaDictionary.SLEEP_CODE);
            ...
            //11. Đánh giá nguy cơ té ngã sử dụng Bảng Morse Scale/ Fall risk assessment with Morse Scale
            Model.fall_history_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.fall_history_code)}_", IinaDictionary.FALL_HISTORY_CODE);
            Model.fall_history_desc = WebHelpers.GetDicDesc(Model.fall_history_code, IinaDictionary.FALL_HISTORY_CODE);

            Model.secon_diagnosis_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.secon_diagnosis_code)}_", IinaDictionary.SECON_DIAGNOSIS_CODE);
            Model.secon_diagnosis_desc = WebHelpers.GetDicDesc(Model.secon_diagnosis_code, IinaDictionary.SECON_DIAGNOSIS_CODE);

            Model.ambula_aids_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.ambula_aids_code)}_", IinaDictionary.AMBULA_AIDS_CODE);
            Model.ambula_aids_desc = WebHelpers.GetDicDesc(Model.ambula_aids_code, IinaDictionary.AMBULA_AIDS_CODE);

            Model.intra_therapy_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.intra_therapy_code)}_", IinaDictionary.INTRA_THERAPY_CODE);
            Model.intra_therapy_desc = WebHelpers.GetDicDesc(Model.intra_therapy_code, IinaDictionary.INTRA_THERAPY_CODE);

            Model.gait_trans_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.gait_trans_code)}_", IinaDictionary.GAIT_TRANS_CODE);
            Model.gait_trans_desc = WebHelpers.GetDicDesc(Model.gait_trans_code, IinaDictionary.GAIT_TRANS_CODE);

            Model.fr_mental_status_code = WebHelpers.GetData(form1, new HtmlInputRadioButton(), $"rad_{nameof(Model.fr_mental_status_code)}_", IinaDictionary.FR_MENTAL_STATUS_CODE);
            ...
            #region IV.	KẾ HOẠCH XUẤT VIỆN/ DISCHARGE PLANING
            ...
            Model.reassessment = txt_reassessment.Value;
            ...
            DataTable instructions_provided_to = FindHtmlInputCheckBox(form1, nameof(Model.instructions_provided_to), IinaDictionary.INSTRUCTIONS_PROVIDED_TO, (KeyValuePair<string, object> dictionary) =>
            {
                ...
                {
                    return txt_instructions_provided_to_other.Value;
                }
                return null;
            });
            ...
            Model.vb_dentures = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"rad_{nameof(Model.vb_dentures)}_");
            if (rad_vb_dentures_true.Checked)
            {
                DataTable vb_dentures_note = FindHtmlInputCheckBox(nameof(Model.vb_dentures_note), IinaDictionary.VB_DENTURES);
                if (vb_dentures_note.Rows.Count > 0)
                {
                    Model.vb_dentures_note = JsonConvert.SerializeObject(vb_dentures_note);
                }
            }

            Model.vb_hearing_aid = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"rad_{nameof(Model.vb_hearing_aid)}_");
            if (rad_vb_hearing_aid_true.Checked)
            {
                DataTable vb_hearing_aid_note = FindHtmlInputCheckBox(nameof(Model.vb_hearing_aid_note), IinaDictionary.VB_HEARING_AID);
                if (vb_hearing_aid_note.Rows.Count > 0)
                {
                    Model.vb_hearing_aid_note = JsonConvert.SerializeObject(vb_hearing_aid_note);
                }
            }

            Model.vb_eyeglasses = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"rad_{nameof(Model.vb_eyeglasses)}_");
            if (rad_vb_eyeglasses_true.Checked)
            {
                DataTable vb_eyeglasses_note = FindHtmlInputCheckBox(nameof(Model.vb_eyeglasses_note), IinaDictionary.VB_EYEGLASSES);
                if (vb_eyeglasses_note.Rows.Count > 0)
                {
                    Model.vb_eyeglasses_note = JsonConvert.SerializeObject(vb_eyeglasses_note);
                }
            }

            Model.vb_contact_lenses = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"rad_{nameof(Model.vb_contact_lenses)}_");
            if (rad_vb_contact_lenses_true.Checked)
            {
                DataTable vb_contact_lenses_note = FindHtmlInputCheckBox(nameof(Model.vb_contact_lenses_note), IinaDictionary.VB_CONTACT_LENSES);
                if (vb_contact_lenses_note.Rows.Count > 0)
                {
                    Model.vb_contact_lenses_note = JsonConvert.SerializeObject(vb_contact_lenses_note);
                }
            }

            Model.vb_cash_jewelry = WebHelpers.GetData(form1, new HtmlInputCheckBox(), $"rad_{nameof(Model.vb_cash_jewelry)}_");
            if (rad_vb_cash_jewelry_true.Checked)
            {
                DataTable vb_cash_jewelry_note = FindHtmlInputCheckBox(nameof(Model.vb_cash_jewelry_note), IinaDictionary.VB_CASH_JEWELRY);
                if (vb_cash_jewelry_note.Rows.Count > 0)
                {
                    Model.vb_cash_jewelry_note = JsonConvert.SerializeObject(vb_cash_jewelry_note);
                }
            }
            Model.vb_other = txt_vb_other.Value;
        ...
        public override void PostBackEventHandler()
        {
            switch (Request["__EVENTTARGET"])
            {
                ...
                case "vb_dentures_change":
                    vb_dentures_note_wrapper.Visible = rad_vb_dentures_true.Checked;
                    break;
                case "vb_hearing_aid_change":
                    vb_hearing_aid_wrapper.Visible = rad_vb_hearing_aid_true.Checked;
                    break;
                case "vb_eyeglasses_change":
                    vb_eyeglasses_wrapper.Visible = rad_vb_eyeglasses_true.Checked;
                    break;
                case "vb_contact_lenses_change":
                    vb_contact_lenses_wrapper.Visible = rad_vb_contact_lenses_true.Checked;
                    break;
                case "vb_cash_jewelry_change":
                    vb_cash_jewelry_wrapper.Visible = rad_vb_cash_jewelry_true.Checked;
                    break;
                case "instructions_provided_to_oth_change":
                    instructions_provided_to_other_wrapper.Visible = cb_instructions_provided_to_oth.Checked;
                    break;
                ...
                case "extremities_ot_change":
                    txt_extremities_other.Visible = cb_extremities_ot.Checked;
                    break;
                case "bowel_elimination_change":
                    txt_bowel_elimination_other.Visible = rad_bowel_elimination_code_oth.Checked;
                    break;
                case "gas_presence_code_change":
                    txt_gas_presence_note.Visible = rad_gas_presence_code_s.Checked;
                    break;
                case "contraception_code_change":
                    contraception_other_wrapper.Visible = rad_contraception_code_oth.Checked;
                    break;
                case "cough_change":
                    cough_true_wrapper.Visible = rad_cough_true.Checked;
                    break;
                case "cur_in_pain_change":
                    cur_in_pain_true_wrapper.Visible = rad_cur_in_pain_true.Checked;
                    break;
                case "using_pain_killer_change":
                    using_pain_killer_true_wrapper.Visible = rad_using_pain_killer_true.Checked;
                    break;
                case "wounds_change":
                    wounds_0_wrapper.Visible = !cb_wounds_0.Checked;
                    break;
            }
        }
        ...
        #endregion
        protected void residence_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_residence_code_vnm.Checked || rad_residence_code_oth.Checked;
        }
        protected void language_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_language_code_vi.Checked || rad_language_code_en.Checked || rad_language_code_oth.Checked;
        }
        protected void req_interpreter_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_req_interpreter_true.Checked || rad_req_interpreter_false.Checked;
        }
        protected void religion_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_religion_code_bh.Checked || rad_religion_code_ch.Checked || rad_religion_code_oth.Checked;
        }
        protected void spiritual_couns_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = txt_occupation.Value != null;
        }
        protected void occupation_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_req_interpreter_true.Checked || rad_req_interpreter_false.Checked;
        }
        protected void living_status_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_living_status_code_aln.Checked || rad_living_status_code_wth.Checked || rad_living_status_code_oth.Checked;
        }
        protected void hospital_concern_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_hospital_concern_code_non.Checked || rad_hospital_concern_code_rel.Checked || rad_hospital_concern_code_fin.Checked || rad_hospital_concern_code_wor.Checked || rad_hospital_concern_code_oth.Checked;
        }
        protected void accompanied_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = txt_accompanied.Value != null;
        }
        protected void relationship_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = txt_relationship.Value != null;
        }
        protected void admit_from_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_admit_from_code_opd.Checked || rad_admit_from_code_er.Checked || rad_admit_from_code_vd.Checked || rad_admit_from_code_oth.Checked;
        }
        protected void arrived_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = cb_arrived_w.Checked || cb_arrived_s.Checked || cb_arrived_wc.Checked || cb_arrived_o.Checked;
        }
        protected void admission_reason_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = txt_admission_reason.Value != null;
        }
        
        protected void substance_abuse_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = cb_substance_abuse_s.Checked || cb_substance_abuse_a.Checked || cb_substance_abuse_oth.Checked;
        }
        protected void is_high_risk_patient_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_is_high_risk_patient_false.Checked || rad_is_high_risk_patient_true.Checked;
        }
        ...
        {
            args.IsValid = rad_vb_dentures_false.Checked
                || rad_vb_dentures_true.Checked;
        }
        protected void vb_hearing_aid_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_vb_hearing_aid_false.Checked
                || rad_vb_hearing_aid_true.Checked;
        }
        protected void vb_eyeglasses_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_vb_eyeglasses_false.Checked
                || rad_vb_eyeglasses_true.Checked;
        }
        protected void vb_contact_lenses_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_vb_contact_lenses_false.Checked
                || rad_vb_contact_lenses_true.Checked;
        }
        protected void vb_cash_jewelry_ServerValidate(object source, ServerValidateEventArgs args)
        {
            args.IsValid = rad_vb_cash_jewelry_false.Checked
                || rad_vb_cash_jewelry_true.Checked;
        }
