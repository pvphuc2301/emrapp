<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisCerV20.aspx.cs" Inherits="EMR.IPD.DisCerV20" %>
                            ...
                            <tr>
                                <td class="report-content-cell">
                                    <div class="main">
                                        ...
                                        <div class="d-grid" style="grid-template-columns: 180px 1fr">
                                            <webUI:Label runat="server" SubTitle="Inpatient admission time" Title="Nhập khoa nội trú lúc:" />
                                            <div runat="server" id="Div7">
                                                <div class="d-inline-block" runat="server" id="Div8">
                                                    <asp:Label class="d-inline-block align-top text-left" style="width: 20px" runat="server" id="prt_admission_hour"></asp:Label>
                                                    <div class="d-inline-block">
                                                        <label class="d-block mb-0">giờ</label>
                                                        <span class="text-primary">hour</span>
                                                    </div>
                                                </div>
                                                <div class="d-inline-block" runat="server" id="Div9">
                                                    <asp:Label class="d-inline-block align-top text-left" style="width: 20px" runat="server" id="prt_admission_minute"></asp:Label>
                                                    <div class="d-inline-block">
                                                        <label class="d-block mb-0">phút,</label>
                                                        <span class="text-primary">minutes,</span>
                                                    </div>
                                                </div>
                                                <div class="d-inline-block" runat="server" id="Div10">
                                                    <div class="d-inline-block">
                                                        <label class="d-block mb-0">ngày</label>
                                                        <span class="text-primary">day</span>
                                                    </div>
                                                    <asp:Label class="d-inline-block align-top text-center" style="width: 20px" runat="server" id="prt_admission_day"></asp:Label>
                                                </div>
                                                <div class="d-inline-block" runat="server" id="Div11">
                                                    <div class="d-inline-block">
                                                        <label class="d-block mb-0">tháng</label>
                                                        <span class="text-primary">month</span>
                                                    </div>
                                                    <asp:Label class="d-inline-block align-top text-center" style="width: 20px" runat="server" id="prt_admission_month"></asp:Label>
                                                </div>
                                                <div class="d-inline-block" runat="server" id="Div12">
                                                    <div class="d-inline-block">
                                                        <label class="d-block mb-0">năm</label>
                                                        <span class="text-primary">year</span>
                                                    </div>
                                                    <asp:Label class="d-inline-block align-top text-center" style="width: 35px" runat="server" id="prt_admission_year"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
