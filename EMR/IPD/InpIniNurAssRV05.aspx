...
<body>
                        ...
                        <tbody class="report-content">
                            <tr>
                                <td class="report-content-cell">
                                    <div class="main" runat="server" id="print_content" style="font-size: 12pt; line-height: 1;">
                                    
                                        <div class="d-grid mb-2 mt-2 font-10" style="grid-template-columns: 260px 1fr; margin-left: -10px">
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 130px 100px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_residence_code_vnm" Text="❏"/></div>
                                                <div>
                                                    <div>Việt Nam</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr;">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_residence_code_oth" Text="❏"/></div>
                                                <div>
                                                    <div>Khác:&nbsp;</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 130px 100px 100px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_language_code_vi" Text="❏"/></div>
                                                <div>
                                                    <div>Tiếng Việt</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_language_code_en" Text="❏"/></div>
                                                <div>
                                                    <div>Tiếng Anh</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_language_code_oth" Text="❏"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 130px 100px 100px">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_req_interpreter_true" Text="❏"/></div>
                                                <div>
                                                    <div>Có</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_req_interpreter_false" Text="❏"/></div>
                                                <div>
                                                    <div>Không</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 65px 75px 110px 1fr 135px 50px 60px">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_religion_code_bh" Text="❏"/></div>
                                                <div>
                                                    <div>Phật giáo</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_religion_code_ch" Text="❏"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr;">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_religion_code_oth" Text="❏"/></div>
                                                <div>
                                                    <div>Khác:&nbsp;</div>
                                                    <div class="subtitle font-10">Other</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_spiritual_couns_true" Text="❏"/></div>
                                                <div>
                                                    <div>Có</div>
                                                    <div class="subtitle font-10">Yes</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_spiritual_couns_false" Text="❏"/></div>
                                                <div>
                                                    <div>Không</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px auto 150px 110px 90px 90px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_living_status_code_aln" Text="❏"/>
                                                <div>
                                                    <div>Một mình</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_living_status_code_wth" Text="❏"/>
                                                <div>
                                                    <div>Gia đình</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_living_status_code_oth" Text="❏"/>
                                                <div>
                                                    <div>Khác:&nbsp;</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 200px 70px 170px 80px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_hospital_concern_code_non" Text="❏"/>
                                                <div>
                                                    <div>Không</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_hospital_concern_code_rel" Text="❏"/>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_hospital_concern_code_fin" Text="❏"/>
                                                <div>
                                                    <div>Tài chính</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_hospital_concern_code_wor" Text="❏"/>
                                                <div>
                                                    <div>Lo âu</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <asp:Label runat="server" CssClass="line-height-1d2" ID="prt_hospital_concern_code_oth" Text="❏"/>
                                                <div>
                                                    <div>Khác:&nbsp;</div>
                                                    <div class="subtitle font-10">Other</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11 mb-1" style="grid-template-columns: 20px 300px 1fr">
                                            <div>-</div>
                                            <div class="d-grid" style="grid-template-columns: auto 1fr">
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 140px 140px 120px 130px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_admit_from_code_opd"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_admit_from_code_er"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_admit_from_code_vd"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_admit_from_code_oth"/></div>
                                                <div>
                                                    <div>Khác:</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 140px 140px 120px 120px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏"  ID="prt_arrived_w"/></div>
                                                <div>
                                                    <div>Tự đi được</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_arrived_s"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_arrived_wc"/></div>
                                                <div>
                                                    <div>Bằng xe lăn</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_arrived_o"/></div>
                                                <div>
                                                    <div>Khác:</div>
                                                    <div class="subtitle font-10">Other&nbsp;</div>
                                                </div>
                                                <asp:Label runat="server" ID="prt_arrived_other"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 310px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_previous_admission_false"/></div>                                             
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_previous_admission_true"/></div>
                                                <div>
                                                    <div>Có, ghi rõ:</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 150px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 1fr 145px">
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_past_med_history_false"/></div>
                                                    <div>
                                                        <div>Không</div>
                                                        <div class="subtitle font-10">No</div>
                                                    </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_past_med_history_true"/></div>
                                                <div>
                                                    <div>Có, ghi rõ:</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 150px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_past_sur_history_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_past_sur_history_true"/></div>
                                                <div>
                                                    <div>Có, ghi rõ:</div>
                                                    <div class="subtitle font-10">Yes, specific</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 180px 100px 100px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_substance_abuse_s"/></div>
                                                <div>
                                                    <div>Hút thuốc</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_substance_abuse_a"/></div>
                                                <div>
                                                    <div>Rượu bia</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_substance_abuse_oth"/></div>
                                                <div>
                                                    <div>Khác, ghi rõ:</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 200px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_previous_document_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_previous_document_true"/></div>
                                                <div>
                                                    <div>Có, ghi rõ:</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 200px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cur_home_medication_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cur_home_medication_true"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 200px 80px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_allergy_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_allergy_true"/></div>
                                                <div>
                                                    <div>Có, ghi rõ:</div>
                                                    <span class="subtitle font-10">Yes, specify</span>
                                                </div>
                                        ...
                                        <div class="d-grid font-11 mb-2" style="grid-template-columns: 205px 100px 1fr; margin-left: -10px">
                                            <div class="font-weight-bold">
                                                <div>Nhóm người bệnh đặc biệt</div>
                                                <div class="subtitle font-10">Special patient group</div>
                                            </div>
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_is_high_risk_patient_false"/></div>
                                                <div class="font-weight-bold">
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_is_high_risk_patient_true"/></div>
                                                <div class="font-weight-bold">
                                                    <div>Có, cụ thể:</div>
                                                    <div class="subtitle font-10">Yes, specify</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 235px 215px 1fr; margin-left: -10px">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_hrt"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_sdp"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_res"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_eld"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_ccp"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_hrf"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_wil"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr; grid-column: 2/4">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_psp"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr; grid-column: 1/3">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_ros"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_isc"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 320px 1fr; margin-left: -10px">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_psd"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_van"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid mb-1" style="grid-template-columns: 15px 1fr; margin-left: -10px">
                                            <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_high_risk_patient_pls"/></div>
                                            <div>
                                                <div>Người bệnh cần hỗ trợ sự sống</div>
                                                <div class="subtitle font-10">Patients on life support</div>
                                            </div>
                                        </div>
                                        <%--<div>
                                        ...
                                        <%-- NURSING ASSESSMENT --%>
                                        <div class="d-grid font-12 font-weight-bold" style="grid-template-columns: 25px 1fr">
                                            <div>III.</div>
                                        ...
                                        <div class="d-grid" style="grid-template-columns: 20px 1fr 1fr 1fr 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: auto 40px 1fr">
                                                <div>- SpO2:</div>
                                                <div><asp:Label runat="server" ID="prt_vs_spo2"/>&nbsp;</div>
                                                <div>%</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 1fr 1fr 1fr 1fr 1fr">
                                            <div></div>
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_respiratory_system_n"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_respiratory_system_d"/></div>
                                                <div>
                                                    <div>Khó thở</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_respiratory_system_o"/></div>
                                                <div>
                                                    <div>Khó thở nằm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_respiratory_system_w"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_respiratory_system_c"/></div>
                                                <div>
                                                    <div>Da xanh tái</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 60px 70px 60px 140px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cough_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cough_true"/></div>
                                                <div>
                                                    <div>Có</div>
                                                    <div class="subtitle font-10">Yes</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pro_cough_false"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pro_cough_true"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 60px 60px 90px 90px 80px 80px 90px 1fr">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pulse_code_r"/></div>
                                                <div>
                                                    <div>Đều</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pulse_code_i"/></div>
                                                <div>
                                                    <div>Không đều</div>
                                            ...
                                            <div class="d-grid font-10" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_presence_cp"/></div>
                                                <div>
                                                    <div>Đau ngực</div>
                                            ...
                                            <div class="d-grid font-10" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_presence_di"/></div>
                                                <div>
                                                    <div>Chóng mặt</div>
                                            ...
                                            <div class="d-grid font-10" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_presence_ca"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid font-10" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_presence_pe"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 60px 60px 80px 80px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_extremities_wa"/></div>
                                                <div>
                                                    <div>Ấm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_extremities_co"/></div>
                                                <div>
                                                    <div>Lạnh</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_extremities_cl"/></div>
                                                <div>
                                                    <div>Ẩm ướt</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_extremities_cy"/></div>
                                                <div>
                                                    <div>Xanh tái</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_extremities_ot"/></div>
                                                <div>
                                                    <div>Khác, ghi rõ:</div>
                                                    <div class="subtitle font-10">Other, specify</div>
                                                </div>
                                                <asp:Label runat="server" ID="prt_extremities_other"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 60px 60px 80px 80px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oriented_pla"/></div>
                                                <div>
                                                    <div>Nơi</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oriented_day"/></div>
                                                <div>
                                                    <div>Ngày</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oriented_time"/></div>
                                                <div>
                                                    <div>Thời gian</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oriented_per"/></div>
                                                <div>
                                                    <div>Người</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oriented_na"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 75px 80px 90px 70px 85px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_al"/></div>
                                                <div>
                                                    <div>Tỉnh táo</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_cf"/></div>
                                                <div>
                                                    <div>Nhầm lẫn</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_ag"/></div>
                                                <div>
                                                    <div>Kích động</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_an"/></div>
                                                <div>
                                                    <div>Lo âu</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_de"/></div>
                                                <div>
                                                    <div>Trầm cảm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_oth"/></div>
                                                <div>
                                                    <div>Khác:</div>
                                            ...
                                            <%--<div style="display: none;">
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_fr"/></div>
                                                    <div>
                                                        <div>Quấy</div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mental_status_le"/></div>
                                                    <div>
                                                        <div>Lơ mơ</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 120px 120px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_hearing_code_n"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_hearing_code_hi"/></div>
                                                <div>
                                                    <div>Khiếm thính</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_hearing_code_ha"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 120px 100px 120px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vision_code_nm"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                                    <div class="subtitle font-10">Normal</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vision_code_gl"/></div>
                                                <div>
                                                    <div>Đeo kính</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vision_code_cl"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vision_code_oth"/></div>
                                                <div>
                                                    <div>Khác, ghi rõ:</div>
                                                    <div class="subtitle font-10">Other, specify</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 140px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 120px 120px 1fr;">
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_speech_code_nm"/></div>
                                                    <div>
                                                        <div>Bình thường</div>
                                                        <div class="subtitle font-10">Normal</div>
                                                    </div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_speech_code_sl"/></div>
                                                    <div>
                                                        <div>Nói lắp</div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_speech_code_ap"/></div>
                                                    <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_speech_code_si"/></div>
                                                    <div>
                                                        <div>Khiếm ngôn</div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_speech_code_nv"/></div>
                                                    <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_speech_code_nc"/></div>
                                                    <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 160px 100px 100px 140px 1fr;">
                                            ...
                                            <div>
                                             ...
                                             <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_code_nm"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                                    <div class="subtitle font-10">Normal</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_code_bf"/></div>
                                                <div>
                                                    <div>Bú bình</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_code_tbf"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_code_oth"/></div>
                                                <div>
                                                    <div>Khác, ghi rõ:</div>
                                                    <div class="subtitle font-10">Other, specify</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 160px 100px 100px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_pre_code_v"/></div>
                                                <div>
                                                    <div>Nôn</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_pre_code_n"/></div>
                                                <div>
                                                    <div>Buồn nôn</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_diet_pre_code_s"/></div>
                                                <div>
                                                    <div>Nuốt khó</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 160px 100px auto auto 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ng_tube_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gastrostomy_true"/></div>
                                                <div>
                                                    <div>Mở dạ dày</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_size_true"/></div>
                                                <div>
                                                    <div>Kích cỡ:</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 160px 100px 100px 100px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bowel_elimination_code_two"/></div>
                                                <div>
                                                    <div>2 lần/ngày</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bowel_elimination_code_one"/></div>
                                                <div>
                                                    <div>1 lần/ngày</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bowel_elimination_code_eod"/></div>
                                                <div>
                                                    <div>Cách ngày</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bowel_elimination_code_oth"/></div>
                                                <div>
                                                    <div>Khác, ghi rõ:</div>
                                                    <div class="subtitle font-10">Other</div>
                                                </div>
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bowel_elimination_other"/></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 160px 100px 120px 80px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_stool_consistency_code_h"/></div>
                                                <div>
                                                    <div>Cứng</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_stool_consistency_code_f"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_stool_consistency_code_l"/></div>
                                                <div>
                                                    <div>Lỏng</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_stool_consistency_code_w"/></div>
                                                <div>
                                                    <div>Phân nước</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 160px 100px 140px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gas_presence_code_n"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                                    <div class="subtitle font-10">Normal</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gas_presence_code_i"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gas_presence_code_s"/></div>
                                                <div>
                                                    <div>Hậu môn nhân tạo:</div>
                                                    <div class="subtitle font-10">Artificial anus</div>
                                                </div>
                                                <asp:Label runat="server" ID="prt_gas_presence_note"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 80px 140px 140px 140px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_urination_nm"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                                    <div class="subtitle font-10">Normal</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_urination_no"/></div>
                                                <div>
                                                    <div>Tiểu đêm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_urination_dy"/></div>
                                                <div>
                                                    <div>Khó tiểu</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_urination_in"/></div>
                                                <div>
                                                    <div>Không kiểm soát</div>
                                            ...
                                            <%--<div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_urination_fr"/>
                                                <div>
                                                    Thường xuyên<br />
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 250px auto auto 20px auto 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 10px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_inter_catheter_true"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ind_catheter_true"/></div>
                                                <div>
                                            ...
                                            <div class="text-center"><asp:Label runat="server" ID="prt_ind_catheter_size"/></div>
                                            <div>Fr,</div>
                                            <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px auto auto 20px auto 1fr;">
                                            <div></div>
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_sup_catheter_true"/></div>
                                                <div>
                                            ...
                                            <div class="text-center"><asp:Label runat="server" ID="prt_sup_catheter_size"/></div>
                                            <div>Fr,</div>
                                            <div>
                                        ...
                                        <div runat="server" id="prt_female_patient_wrapper">
                                            <div class="d-grid font-11 font-weight-bold" style="grid-template-columns: 20px 1fr;">
                                                <div></div>
                                            ...
                                            <div class="d-grid font-11" style="grid-template-columns: 20px 100px 100px 100px auto 10px auto 1fr;">
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_menstruation_code_am"/></div>
                                                    <div>
                                                        <div>Vô kinh</div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_menstruation_code_me"/></div>
                                                    <div>
                                                        <div>Mãn kinh</div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_menstruation_code_cy"/></div>
                                                    <div>
                                                        <div>Chù kỳ</div>
                                            ...
                                            <div class="d-grid font-11" style="grid-template-columns: 20px 100px 100px auto 40px 1fr;">
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_not_pregnancy_true"/></div>
                                                    <div>
                                                        <div>Không</div>
                                                        <div class="subtitle font-10">No</div>
                                                    </div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pre_pregnancy_true"/></div>
                                                    <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px auto 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cur_pregnancy_true"/></div>
                                                    <div>
                                                        <div>Hiện đang mang thai</div>
                                                        <div class="subtitle font-10">Current pregnancy</div>
                                                    </div>
                                                    <div class="text-center"><asp:Label runat="server" ID="prt_pregnancy_week"/></div>
                                                    <div>
                                                        <div>tuần</div>
                                            ...
                                            <div class="d-grid font-11" style="grid-template-columns: 20px 90px 80px 130px 250px 1fr;">
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_contraception_code_no"/></div>
                                                    <div>
                                                        <div>Không</div>
                                                        <div class="subtitle font-10">No</div>
                                                    </div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_contraception_code_pill"/></div>
                                                    <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_contraception_code_dev"/></div>
                                                    <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_contraception_code_oth"/></div>
                                                    <div>
                                                        <div>Khác:</div>
                                                        <div class="subtitle font-10">Other</div>
                                                    </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 100px 1fr;">
                                            ...
                                            <div>
                                                <div class="d-grid" style="grid-template-columns: 100px 100px 100px 1fr;">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mus_history_nm"/></div>
                                                        <div>
                                                            <div>Bình thường</div>
                                                            <div class="subtitle font-10">Normal</div>
                                                        </div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mus_history_jp"/></div>
                                                        <div>
                                                            <div>Đau khớp</div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mus_history_js"/></div>
                                                        <div>
                                                            <div>Sưng khớp</div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_mus_history_ms"/></div>
                                                        <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 300px 1fr;">
                                                    <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_paralysis_true"/></div>
                                                        <div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_amputation_true"/></div>
                                                        <div>
                                                            <div>Đoạn chi:</div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_contracture_true"/></div>
                                                        <div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_prosthesis_true"/></div>
                                                        <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 180px 80px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cur_in_pain_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_cur_in_pain_true"/></div>
                                                <div>
                                        ...
                                        <div runat="server" id="prt_cur_in_pain_true_wrapper">
                                            <div class="d-grid mb-1" style="grid-template-columns: 1fr 265px; margin-left: -20px;">
                                                <div>
                                            ...
                                            <div class="d-grid font-11" style="grid-template-columns: 20px 200px 80px 1fr;">
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_using_pain_killer_false"/></div>
                                                    <div>
                                                        <div>Không</div>
                                                        <div class="subtitle font-10">No</div>
                                                    </div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                    <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_using_pain_killer_true"/></div>
                                                    <div>
                                            ...
                                            <div runat="server" id="prt_using_pain_killer_true_wrapper" class="d-grid font-11" style="grid-template-columns: 20px 280px 1fr;">
                                                <div>-</div>
                                                <div>
                                                    <div class="d-grid" style="grid-template-columns: auto 1fr">
                                                        <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 80px 100px 50px 50px 80px 50px 60px 110px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_nm"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                                    <div class="subtitle font-10">Normal</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_pa"/></div>
                                                <div>
                                                    <div>Tái</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_fl"/></div>
                                                <div>
                                                    <div>Đỏ</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_ja"/></div>
                                                <div>
                                                    <div>Vàng da</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_dr"/></div>
                                                <div>
                                                    <div>Khô</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_oi"/></div>
                                                <div>
                                                    <div>Nhờn</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_sw"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_condition_ra"/></div>
                                                <div>
                                                    <div>Phát ban</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 75px 65px 85px 120px 80px 70px 85px 1fr;">
                                            <div>-</div>
                                            <div>
                                                <div>Vết thương:</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_0"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_1"/></div>
                                                <div>
                                                    <div>Máu tụ (1)</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_2"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_3"/></div>
                                                <div>
                                                    <div>Rách (3)</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_4"/></div>
                                                <div>
                                                    <div>Sẹo (4)</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_5"/></div>
                                                <div>
                                                    <div>Phỏng (5)</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_wounds_6"/></div>
                                                <div>
                                        ...
                                        <div runat="server" id="prt_wounds_0_wrapper">
                                            <div class="d-grid font-11" style="grid-template-columns: 20px 1fr;">
                                                <div>-</div>
                                                <div>
                                        ...
                                        <table class="table-bordered mb-1" style="width: calc(210mm - 2.8cm)">
                                            <tr>
                                        ...
                                        <div class="d-grid font-10" style="grid-template-columns: 20px 200px 1fr 1fr 1fr;">
                                            ...
                                            <div class="d-grid font-weight-bold" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pres_sore_risk_code_v"/></div>
                                                <div>
                                                    <div>Rất cao (≤10)</div>
                                            ...
                                            <div class="d-grid font-weight-bold" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pres_sore_risk_code_h"/></div>
                                                <div>
                                                    <div>Cao (11 -17)</div>
                                            ...
                                            <div class="d-grid font-weight-bold" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_pres_sore_risk_code_l"/></div>
                                                <div>
                                                    <div>Thấp (≥18)</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 100px 100px 150px 150px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bathing_code_in"/></div>
                                                <div>
                                                    <div>Tự tắm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bathing_code_as"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bathing_code_ab"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_bathing_code_db"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 138px 100px 165px 150px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oral_care_code_oc"/></div>
                                                <div>
                                                    <div>Tự làm</div>
                                                    <div class="subtitle font-10">Independent</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oral_care_code_pu"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_oral_care_code_ab"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 15px 1fr">
                                                <div><asp:Label CssClass="align-top text-right line-height-1d2" runat="server" Text="❏" ID="prt_oral_care_code_oth"/></div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 80px 100px 100px 100px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_dentures_code_n"/></div>
                                                <div>
                                                    <div>Không có</div>
                                                    <div class="subtitle font-10">None</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_dentures_code_u"/></div>
                                                <div>
                                                    <div>Hàm trên</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_dentures_code_l"/></div>
                                                <div>
                                                    <div>Hàm dưới</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_dentures_code_p"/></div>
                                                <div>
                                                    <div>Từng phần</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 80px 1fr;">
                                            ...
                                            <div>
                                                <div class="d-grid" style="grid-template-columns: 85px 175px 1fr;">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_in"/></div>
                                                        <div>
                                                            <div>Tự vệ sinh</div>
                                                            <div class="subtitle font-10">Independent</div>
                                                        </div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_at"/></div>
                                                        <div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_ac"/></div>
                                                        <div>
                                                ...
                                                <div class="d-grid" style="grid-template-columns: 70px 145px 120px 1fr;">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_di"/></div>
                                                        <div>
                                                            <div>Tã</div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_bu"/></div>
                                                        <div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_ca"/></div>
                                                        <div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_toilet_use_code_uc"/></div>
                                                        <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 85px 100px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_dressing_code_in"/></div>
                                                <div>
                                                    <div>Tự làm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_dressing_code_wa"/></div>
                                                <div>
                                                    <div>Cần hỗ trợ</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 90px 100px 150px 170px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_eating_code_in"/></div>
                                                <div>
                                                    <div>Tự ăn</div>
                                                    <div class="subtitle font-10">Independent</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_eating_code_dp"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_eating_code_da"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_eating_code_tu"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 180px 100px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_turning_bed_code_in"/></div>
                                                <div>
                                                    <div>Tự xoay trở</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_turning_bed_code_dn"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 100px 100px 100px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ambulation_code_in"/></div>
                                                <div>
                                                    <div>Tự đi</div>
                                                    <div class="subtitle font-10">Independent</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ambulation_code_bf"/></div>
                                                <div>
                                                    <div>Liệt giường</div>
                                                    <div class="subtitle font-10">Bedridden</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ambulation_code_na"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 80px 110px 110px 130px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_sleep_code_nm"/></div>
                                                <div>
                                                    <div>Bình thường</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_sleep_code_ae"/></div>
                                                <div>
                                                    <div>Thức sớm</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_sleep_code_pfa"/></div>
                                                <div>
                                                    <div>Khó ngủ</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_sleep_code_pst"/></div>
                                                <div>
                                                    <div>Khó ngủ say</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 80px 1fr;">
                                            ...
                                            <div></div>
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_medication_used_true"/></div>
                                                <div>
                                        ...
                                        <table class="table-bordered font-11" style="width: calc(210mm - 2.8cm)">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div style="width: 185px">
                                                        <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                            <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fall_history_code_25"/></div>
                                                            <div>Có/ <span class="subtitle">Yes</span> = 25</div>
                                                        </div>
                                                        <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                            <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fall_history_code_0"/></div>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_secon_diagnosis_code_15"/></div>
                                                        <div>Có/ <span class="subtitle font-10">Yes</span> = 15</div>
                                                    </div>
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_secon_diagnosis_code_0"/></div>
                                                        <div>Không/ <span class="subtitle font-10">No</span> = 0</div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ambula_aids_code_0"/></div>
                                                        <div>
                                                            Không cần trợ giúp để đi lại hoặc nằm tại giường/ <span class="subtitle font-10">No ambulatory aid or bedrest</span> = 0
                                                        </div>
                                                    </div>
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ambula_aids_code_15"/></div>
                                                        <div>
                                                    ...
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_ambula_aids_code_30"/></div>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_intra_therapy_code_20"/></div>
                                                        <div>
                                                            Có/<span class="subtitle font-10">Yes</span> = 20
                                                        </div>
                                                    </div>
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_intra_therapy_code_0"/></div>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gait_trans_code_20"/></div>
                                                        <div>
                                                            Suy yếu/<span class="subtitle font-10">Impaired</span> = 20
                                                        </div>
                                                    </div>
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gait_trans_code_10"/></div>
                                                        <div>
                                                            Yếu/<span class="subtitle font-10">Weak</span> = 10
                                                        </div>
                                                    </div>
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_gait_trans_code_0"/></div>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fr_mental_status_code_0"/></div>
                                                        <div>
                                                            Hiểu được giới hạn bản thân = 0/ <span class="subtitle font-10">Understanding of personal limits</span>
                                                        </div>
                                                    </div>
                                                    <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                        <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fr_mental_status_code_15"/></div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="d-grid" style="grid-template-columns: auto auto auto auto">
                                                        ...
                                                        <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                            <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fr_total_score_l"/></div>
                                                            <div class="font-weight-bold">
                                                                <div>Thấp (0-24)</div>
                                                        ...
                                                        <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                            <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fr_total_score_m"/></div>
                                                            <div class="font-weight-bold">
                                                        ...
                                                        <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                            <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_fr_total_score_h"/></div>
                                                            <div class="font-weight-bold">
                                                                <div>Cao (≥45)</div>
                                        ...
                                        <div class="font-weight-bold mt-2 mb-2">IV. KẾ HOẠCH XUẤT VIỆN/ <span class="subtitle">DISCHARGE PLANING</span></div>
                                        ...
                                        <table class="table-bordered font-11" style="width: calc(210mm - 2.8cm)">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><asp:Label Text="❏" runat="server" ID="prt_involvement_true"/></td>
                                                <td class="text-center"><asp:Label Text="❏" runat="server" ID="prt_involvement_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-center"><asp:Label Text="❏" runat="server" ID="prt_req_med_equipment_true"/></td>
                                                <td class="text-center"><asp:Label Text="❏" runat="server" ID="prt_req_med_equipment_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Yêu cầu theo dõi điều trị/ <span class="subtitle font-10">Require to follow-up</span></td>
                                                <td class="text-center"><asp:Label Text="❏" runat="server" ID="prt_req_foll_care_true"/></td>
                                                <td class="text-center"><asp:Label Text="❏" runat="server" ID="prt_req_foll_care_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Các trường hợp tự tử (cần hội chẩn khẩn cấp)/ <span class="subtitle font-10">Suicidal cases (Urgent referral)</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_suicidal_referral_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_suicidal_referral_false"/></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_alone_reduce_functional_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_alone_reduce_functional_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Mời bác sĩ vật lý trị liệu hội chẩn/ <span class="subtitle font-10">Referral to Physiotherapist</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_physiotherapist_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_physiotherapist_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Mời chuyên gia ngôn ngữ trị liệu hội chẩn/ <span class="subtitle font-10">Referral to speech therapist</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_speech_therapist_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_speech_therapist_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Giới thiệu đến chuyên gia dinh dưỡng/ <span class="subtitle font-10">Referral to Dietician</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_dietician_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_dietician_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Giới thiệu đến chuyên gia tâm lý/ <span class="subtitle font-10">Referral to Psychologist</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_psychologist_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_psychologist_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Yêu cầu chuyển đến bệnh viện khác/ <span class="subtitle font-10">Referral to other hospital</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_other_hospital_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_ref_other_hospital_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Người nhà hỗ trợ tại nhà/ <span class="subtitle font-10">Family support athome</span>
                                                </td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_support_at_home_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_support_at_home_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_req_transportation_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_req_transportation_false"/></td>
                                            </tr>
                                            <tr>
                                                <td>Cầu thang bộ tại nhà/ <span class="subtitle font-10">Stairts at home</span></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_stairs_climb_home_true"/></td>
                                                <td class="text-center"><asp:Label runat="server" Text="❏" ID="prt_stairs_climb_home_false"/></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="table-bordered" style="width: calc(210mm - 2.8cm); margin-top: -1px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label runat="server" ID="prt_reassessment"/>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <div class="d-grid" style="grid-template-columns: 1fr 1fr;">
                                            <div class="text-center">
                                                <div>Ngày/<span class="subtitle font-10">Date</span> <asp:Label runat="server" ID="prt_initial_assessment_date"/> Giờ/<span class="subtitle font-10">Time</span> <asp:Label runat="server" ID="prt_initial_assessment_time"/></div>
                                            ...
                                            <div class="text-center">
                                                <div>Ngày/<span class="subtitle font-10">Date</span> <asp:Label runat="server" ID="prt_reassessment_date"/> Giờ/<span class="subtitle font-10">Time</span> <asp:Label runat="server" ID="prt_reassessment_time"/></div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 140px 100px 100px 1fr 120px;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="align-top " runat="server" Text="❏" ID="prt_instructions_provided_to_pat"/></div>
                                                <div>
                                                    <div>Người bệnh</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_instructions_provided_to_rel"/></div>
                                                <div>
                                                    <div>Thân nhân</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px auto 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_instructions_provided_to_oth"/></div>
                                                <div>
                                                    <div>Khác:</div>
                                                    <div class="subtitle font-10">Others</div>
                                                </div>
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" ID="prt_instructions_provided_to_other"/></div>
                                            </div>
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_instructions_provided_to_nap"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 1fr 1fr">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_personnel_sta"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_personnel_pat"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 200px 1fr 1fr 1fr">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_physical_facilities_bel"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_physical_facilities_bat"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_physical_facilities_tel"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_physical_facilities_tep"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 200px 1fr">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_physical_facilities_ncs"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_physical_facilities_mco"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 200px 140px 1fr 1fr">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_policies_and_procedure_vih"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_policies_and_procedure_pcc"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_policies_and_procedure_pun"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_policies_and_procedure_mse"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 340px 1fr">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_policies_and_procedure_ppp"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_policies_and_procedure_wcn"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 1fr 1fr">
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_safety_precautions_lfe"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_safety_precautions_fpr"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_safety_precautions_iwb"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_safety_precautions_nsh"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 70px 65px 45px 90px 115px 55px 75px 80px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_true"/></div>
                                                <div>
                                                    <div>Có</div>
                                                    <div class="subtitle font-10">Yes</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_wpa"/></div>
                                                <div>
                                                    <div>NB giữ</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_note_wre"/></div>
                                                <div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_note_max"/></div>
                                                <div>
                                                    <div>Hàm trên</div>
                                                    <div class="subtitle font-10">Maxilla</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_note_man"/></div>
                                                <div>
                                                    <div>Hàm dưới</div>
                                                    <div class="subtitle font-10">Mandible</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_dentures_note_par"/></div>
                                                <div>
                                                    <div>Từng phần</div>
                                                    <div class="subtitle font-10">Partial</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 90px 65px 45px 90px 115px 55px 75px 80px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_hearing_aid_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_hearing_aid_true"/></div>
                                                <div>
                                                    <div>Có</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_hearing_aid_note_wpa"/></div>
                                                <div>
                                                    <div>NB giữ</div>
                                                    <div class="subtitle font-10">With patient</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_hearing_aid_note_wre"/></div>
                                                <div>
                                                    <div>Thân nhân giữ</div>
                                                    <div class="subtitle font-10">With relative</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_hearing_aid_note_lef"/></div>
                                                <div>
                                                    <div>Trái</div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_hearing_aid_note_rig"/></div>
                                                <div>
                                                    <div>Phải</div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 100px 65px 45px 90px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_eyeglasses_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_eyeglasses_true"/></div>
                                                <div>
                                                    <div>Có</div>
                                                    <div class="subtitle font-10">Yes</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_eyeglasses_note_wpa"/></div>
                                                <div>
                                                    <div>NB giữ</div>
                                                    <div class="subtitle font-10">With patient</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_eyeglasses_note_wre"/></div>
                                                <div>
                                                    <div>Thân nhân giữ</div>
                                                    <div class="subtitle font-10">With relative</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 65px 45px 90px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_contact_lenses_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_contact_lenses_true"/></div>
                                                <div>
                                                    <div>Có</div>
                                                    <div class="subtitle font-10">Yes</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_contact_lenses_note_wpa"/></div>
                                                <div>
                                                    <div>NB giữ</div>
                                                    <div class="subtitle font-10">With patient</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_contact_lenses_note_wre"/></div>
                                                <div>
                                                    <div>Thân nhân giữ</div>
                                                    <div class="subtitle font-10">With relative</div>
                                                </div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px 120px 65px 45px 90px 120px 1fr;">
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_cash_jewelry_false"/></div>
                                                <div>
                                                    <div>Không</div>
                                                    <div class="subtitle font-10">No</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_cash_jewelry_true"/></div>
                                                <div>
                                                    <div>Có</div>
                                                    <div class="subtitle font-10">Yes</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_cash_jewelry_note_wpa"/></div>
                                                <div>
                                                    <div>NB giữ</div>
                                                    <div class="subtitle font-10">With patient</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_cash_jewelry_note_wre"/></div>
                                                <div>
                                                    <div>Thân nhân giữ</div>
                                                    <div class="subtitle font-10">With relative</div>
                                                </div>
                                            ...
                                            <div class="d-grid" style="grid-template-columns: 15px 1fr">
                                                <div><asp:Label CssClass="line-height-1d2" runat="server" Text="❏" ID="prt_vb_cash_jewelry_note_hsb"/></div>
                                                <div>
                                        ...
                                        <div class="d-grid font-11" style="grid-template-columns: 20px auto 1fr;">
                                            ...
                                            <asp:Label runat="server" ID="prt_vb_other"/>
                                        </div>
                        ...
                        <div class="form-body">
                            ...
                            <div class="row mb-1">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <asp:Label runat="server" ID="lbl_arrival_date_time"></asp:Label>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="residence_desc_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator11" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="residence_ServerValidate"></asp:CustomValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="language_desc_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator12" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="language_ServerValidate"></asp:CustomValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="req_interpreter_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator13" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="req_interpreter_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="religion_code_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator14" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="religion_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="spiritual_couns_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator15" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="spiritual_couns_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div class="form-group d-inline-block" runat="server" id="occupation_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator16" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="occupation_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="living_status_code_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator17" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="living_status_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="hospital_concern_code_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator18" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="hospital_concern_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div class="form-group" runat="server" id="accompanied_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator19" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="accompanied_ServerValidate"></asp:CustomValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div class="form-group" runat="server" id="relationship_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator20" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="relationship_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="admit_from_desc_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator21" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="admit_from_ServerValidate"></asp:CustomValidator>
                                    ...
                                    <div runat="server" id="arrived_wrapper">
                                        <asp:UpdatePanel ID="updatePanel1" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:CustomValidator ID="CustomValidator22" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="arrived_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div class="form-group" runat="server" id="admission_reason_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator23" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="admission_reason_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="past_med_history_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator24" ValidationGroup="Group2" runat="server" Display="Dynamic" ErrorMessage="Field is required" CssClass="text-danger" OnServerValidate="past_med_history_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="past_sur_history_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator25" ValidationGroup="Group1" runat="server" Display="Dynamic" ErrorMessage="field is required" CssClass="text-danger" OnServerValidate="past_sur_history_ServerValidate"></asp:CustomValidator>
                                    ...
                                    <div runat="server" id="substance_abuse_wrapper">
                                        <asp:UpdatePanel ID="updatePanel11" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:CustomValidator ID="CustomValidator26" ValidationGroup="Group1" runat="server" Display="Dynamic" ErrorMessage="field is required" CssClass="text-danger" OnServerValidate="substance_abuse_ServerValidate"></asp:CustomValidator>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="previous_document_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator27" ValidationGroup="Group1" runat="server" Display="Dynamic" ErrorMessage="field is required" CssClass="text-danger" OnServerValidate="previous_document_ServerValidate"></asp:CustomValidator>
                                ...
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="cur_home_medication_wrapper">
                                        ...
                                        <div class="custom-control custom-radio d-inline-block">
                                            ...
                                            <asp:CustomValidator ID="CustomValidator28" ValidationGroup="Group1" runat="server" Display="Dynamic" ErrorMessage="field is required" CssClass="text-danger" OnServerValidate="cur_home_medication_ServerValidate"></asp:CustomValidator>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div runat="server" id="allergy_wrapper">
                                        ...
                                        <asp:CustomValidator ID="CustomValidator29" ValidationGroup="Group1" runat="server" Display="Dynamic" ErrorMessage="field is required" CssClass="text-danger" OnServerValidate="allergy_ServerValidate"></asp:CustomValidator>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 gt-2-a">
                                            ...
                                            <div runat="server" id="is_high_risk_patient_wrapper">
                                                ...
                                                <asp:CustomValidator ID="CustomValidator30" ValidationGroup="Group1" runat="server" Display="Dynamic" ErrorMessage="field is required" CssClass="text-danger" OnServerValidate="is_high_risk_patient_ServerValidate"></asp:CustomValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-12 gt-2-a" runat="server" id="is_high_risk_patient_true_wrapper">
                                            ...
                                            <div runat="server" id="high_risk_patient_wrapper">
                                                ...
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" runat="server" id="cb_high_risk_patient_psd" />
                                                    <span class="custom-control-label">Người bệnh nghi ngờ bị nghiện/ <span class="text-primary">Patients suspected of drug and/or alcohol dependency</span></span>
                                                </label>
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" runat="server" id="cb_high_risk_patient_van" />
                                                    <span class="custom-control-label">Người bệnh có nguy cơ bị lạm dụng/ ngược đãi/ <span class="text-primary">Victims of abuse or neglect</span></span>
                                                </label>
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" runat="server" id="cb_high_risk_patient_pls" />
                                                    <span class="custom-control-label">Người bệnh cần hỗ trợ sự sống/ <span class="text-primary">Patients on life support</span></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <ContentTemplate>
                                                <div>
                                                    ...
                                                    <div runat="server" class="d-inline-block" id="cough_wrapper">
                                                        <div class="custom-control custom-radio d-inline-block">
                                                            <input onchange="__doPostBack('cough_change','')" type="radio" runat="server" id="rad_cough_false" name="rad_cough" class="custom-control-input" />
                                                            <label class="custom-control-label" for="rad_cough_false">Không/ <span class="text-primary">No</span></label>
                                                        </div>

                                                        <div class="custom-control custom-radio d-inline-block">
                                                            <input onchange="__doPostBack('cough_change','')" type="radio" runat="server" id="rad_cough_true" name="rad_cough" class="custom-control-input" />
                                                ...
                                                <div runat="server" id="cough_true_wrapper">
                                                    ...
                                                    <div runat="server" id="pro_cough_wrapper">
                                                        ...
                                                        <div class="form-group pro_cough_note_field d-inline-block">
                                                            <webUI:TextField Width="320px" runat="server" ID="txt_pro_cough_note" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </ContentTemplate>
                                    ...
                                    <div runat="server" id="extremities_wrapper">
                                        <asp:UpdatePanel ID="updatePanel16" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <label class="custom-control custom-checkbox d-inline-block">
                                                    <input onchange="__doPostBack('extremities_ot_change','')" type="checkbox" class="custom-control-input" runat="server" id="cb_extremities_ot" />
                                                    <span class="custom-control-label">Khác, ghi rõ/ <span class="text-primary">Other, specify</span></span>
                                                </label>
                                                <webUI:TextField runat="server" ID="txt_extremities_other" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-inline-block" runat="server" id="bowel_elimination_code_wrapper">
                                        <asp:UpdatePanel ID="updatePanel13" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <webUI:TextField runat="server" ID="txt_bowel_elimination_other" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                                    ...
                                    <div class="gt-2-a">
                                        ...
                                        <div runat="server" id="contraception_code_wrapper">
                                            <asp:UpdatePanel ID="updatePanel10" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div class="custom-control custom-radio mr-2 d-inline-block">
                                                        <input onchange="__doPostBack('contraception_code_change','')" type="radio" runat="server" id="rad_contraception_code_no" name="rad_contraception_code" class="custom-control-input" />
                                                        <label class="custom-control-label" for="rad_contraception_code_no">Không/ <span class="text-primary">No</span></label>
                                                    </div>
                                                    <div class="custom-control custom-radio mr-2 d-inline-block">
                                                        <input onchange="__doPostBack('contraception_code_change','')" type="radio" runat="server" id="rad_contraception_code_pill" name="rad_contraception_code" class="custom-control-input" />
                                                    ...
                                                    <div class="custom-control custom-radio mr-2 d-inline-block">
                                                        <input onchange="__doPostBack('contraception_code_change','')" type="radio" runat="server" id="rad_contraception_code_dev" name="rad_contraception_code" class="custom-control-input" />
                                                    ...
                                                    <div class="custom-control custom-radio mr-2 d-inline-block">
                                                        <input onchange="__doPostBack('contraception_code_change','')" type="radio" runat="server" id="rad_contraception_code_oth" name="rad_contraception_code" class="custom-control-input" />
                                                        <label class="custom-control-label" for="rad_contraception_code_oth">Khác/ <span class="text-primary">Other</span></label>
                                                    </div>
                                                    <div class="form-group d-inline-block" runat="server" id="contraception_other_wrapper">
                                                        <webUI:TextField Width="320px" runat="server" ID="txt_contraception_other" />
                                                    </div>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                ...
                                <div class="col-md-12 gt-2-a">
                                    ...
                                    <div>
                                        ...
                                        <div runat="server" class="mb-2" id="paralysis_wrapper">
                                            ...
                                            <div class="form-group mt-1 d-inline-block">
                                                <webUI:TextField Width="320px" runat="server" ID="txt_paralysis_note" />
                                            </div>
                                        </div>
                                        ...
                                        <div runat="server" class="mb-2" id="amputation_wrapper">
                                            ...
                                            <div class="form-group d-inline-block">
                                                <webUI:TextField Width="320px" runat="server" ID="txt_amputation_note" />
                                            </div>
                                        </div>
                                        ...
                                        <div runat="server" class="mb-2" id="contracture_wrapper">
                                            ...
                                            <div class="form-group d-inline-block">
                                                <webUI:TextField Width="320px" runat="server" ID="txt_contracture_note" />
                                            </div>
                                        </div>
                                        ...
                                        <div runat="server" id="prosthesis_wrapper">
                                            ...
                                            <div class="form-group d-inline-block">
                                                <webUI:TextField Width="320px" runat="server" ID="txt_prosthesis_note" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <asp:UpdatePanel ID="updatePanel18" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12 mb-2 gt-2-a">
                                            ...
                                            <div class="d-inline-block" runat="server" id="cur_in_pain_wrapper">
                                                <div class="custom-control custom-radio d-inline-block mr-2">
                                                    <input onchange="__doPostBack('cur_in_pain_change','')" type="radio" id="rad_cur_in_pain_false" runat="server" name="rad_cur_in_pain" class="custom-control-input" />
                                                    <label class="custom-control-label" for="rad_cur_in_pain_false">
                                                        Không/ <span class="text-primary">No</span>
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-radio d-inline-block">
                                                    <input onchange="__doPostBack('cur_in_pain_change','')" type="radio" id="rad_cur_in_pain_true" runat="server" name="rad_cur_in_pain" class="custom-control-input" />
                                        ...
                                        <div runat="server" id="cur_in_pain_true_wrapper">
                                            <div class="col-md-12 mb-2">
                                            ...
                                            <div class="col-md-12 mb-2 gt-2-a">
                                                ...
                                                <div class="" style="width: 500px;">
                                                    ...
                                                    <div class="text-center font-weight-bold font-10">Đánh dấu (X) vùng đau trên sơ đồ</div>
                                                    <div class="text-center font-weight-bold subtitle font-10">Mark a cross (X) to indicate the pain location on the body diagram</div>
                                                    <img src="/images/iina_pain_assessment.png" runat="server" width="280" id="Img2" alt="Alternate Text" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2 gt-2-a">
                                                ...
                                                <div runat="server" id="using_pain_killer_wrapper">
                                                    <div class="custom-control custom-radio d-inline-block mr-2" runat="server" id="sing_pain_killer_wrapper">
                                                        <input onchange="__doPostBack('using_pain_killer_change','')" type="radio" id="rad_using_pain_killer_false" runat="server" name="rad_using_pain_killer" class="custom-control-input" />
                                                    ...
                                                    <div class="custom-control custom-radio d-inline-block">
                                                        <input onchange="__doPostBack('using_pain_killer_change','')" type="radio" id="rad_using_pain_killer_true" runat="server" name="rad_using_pain_killer" class="custom-control-input" />
                                            ...
                                            <div runat="server" id="using_pain_killer_true_wrapper">
                                                <div class="col-md-12 mb-2 gt-2-a">
                                    ...
                                    <ContentTemplate>
                                        <div class="col-md-12 mb-2 gt-2-a">
                                            ...
                                            <div runat="server" id="wounds_wrapper">
                                                <label class="custom-control custom-checkbox mb-1 d-inline">
                                                    <input onchange="__doPostBack('wounds_change','')" type="checkbox" class="custom-control-input" runat="server" id="cb_wounds_0" />
                                                    <span class="custom-control-label">Không/ <span class="text-primary">No</span></span>
                                                </label>
                                                <label class="custom-control custom-checkbox mb-1 d-inline">
                                        ...
                                        <div runat="server" id="wounds_0_wrapper">
                                            <div class="col-md-12 mb-2">
                                                <div>Biểu thị vùng da với chỉ số tương ứng trên sơ đồ cơ thể và mô tả vết thương dưới đây</div>
                                                ...
                                                <asp:UpdatePanel ID="updatePanel_skin_anno" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                            ...
                            <fieldset class="row mb-2">
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        <asp:Label runat="server" ID="lbl_bathing_desc"></asp:Label>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <fieldset class="row mb-2">
                                        <legend>
                                            <label class="control-label mb-2">11. Đánh giá nguy cơ té ngã sử dụng Bảng Morse Scale/ <span class="text-primary">Fall risk assessment with Morse Scale</span></label>
                                        </legend>
                            ...
                            <div class="col-md-12 gt-2-a mb-2">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label runat="server" ID="lbl_instructions_provided_to_other"></asp:Label>
                                        <div class="form-group d-inline-block" runat="server" id="instructions_provided_to_other_wrapper">
                                            <webUI:TextField Width="320px" runat="server" ID="txt_instructions_provided_to_other" />
                                        </div>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                            ...
                            <div class="col-md-12 gt-2-a mb-2">
                                <label></label>
                                <asp:UpdatePanel ID="vb_dentures_wrapper" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="custom-control custom-radio d-inline-block">
                                            <input onchange="__doPostBack('vb_dentures_change','')" type="radio" id="rad_vb_dentures_false" runat="server" name="rad_vb_dentures" class="custom-control-input" />
                                            <label class="custom-control-label" for="rad_vb_dentures_false">
                                                Không/ <span class="text-primary">No</span>
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio d-inline-block">
                                            <input onchange="__doPostBack('vb_dentures_change','')" type="radio" id="rad_vb_dentures_true" runat="server" name="rad_vb_dentures" class="custom-control-input" />
                                            <label class="custom-control-label" for="rad_vb_dentures_true">
                                                Có/ <span class="text-primary">Yes</span>
                                            </label>
                                        </div>
                                        <div runat="server" class="d-inline-block" id="vb_dentures_note_wrapper">
                                            <label class="custom-control custom-checkbox mb-1 d-inline">
                                                <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_dentures_note_wpa" />
                                                <span class="custom-control-label">NB giữ/ <span class="text-primary">With patient</span></span>
                                            </label>
                                                
                                            <label class="custom-control custom-checkbox mb-1 d-inline">
                                                <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_dentures_note_wre" />
                                            ...
                                            <label class="custom-control custom-checkbox mb-1 d-inline">
                                                <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_dentures_note_max" />
                                                <span class="custom-control-label">Hàm trên/ <span class="text-primary">Maxilla</span></span>
                                            </label>
                                                
                                            <label class="custom-control custom-checkbox mb-1 d-inline">
                                                <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_dentures_note_man" />
                                                <span class="custom-control-label">Hàm dưới/ <span class="text-primary">Mandible</span></span>
                                            </label>
                                                
                                            <label class="custom-control custom-checkbox mb-1 d-inline">
                                                <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_dentures_note_par" />
                            ...
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_hearing_aid_change','')" type="radio" id="rad_vb_hearing_aid_false" runat="server" name="rad_vb_hearing_aid" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_hearing_aid_false">
                                            Không/ <span class="text-primary">No</span>
                                        </label>
                                    </div>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_hearing_aid_change','')" type="radio" id="rad_vb_hearing_aid_true" runat="server" name="rad_vb_hearing_aid" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_hearing_aid_true">
                                            Có/ <span class="text-primary">Yes</span>
                                        </label>
                                    </div>
                                    <div runat="server" id="vb_hearing_aid_wrapper" class="d-inline-block">
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_hearing_aid_note_wpa" />
                                            <span class="custom-control-label">NB giữ/ <span class="text-primary">With patient</span></span>
                                        </label>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_hearing_aid_note_wre" />
                                            <span class="custom-control-label">Thân nhân giữ/ <span class="text-primary">With relative</span></span>
                                        </label>
                                        Ghi rõ:
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_hearing_aid_note_lef" />
                                            <span class="custom-control-label">Trái/ <span class="text-primary">Left</span></span>
                                        </label>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_hearing_aid_note_rig" />
                            ...
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_eyeglasses_change','')" type="radio" id="rad_vb_eyeglasses_false" runat="server" name="rad_vb_eyeglasses" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_eyeglasses_false">
                                            Không/ <span class="text-primary">No</span>
                                        </label>
                                    </div>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_eyeglasses_change','')" type="radio" id="rad_vb_eyeglasses_true" runat="server" name="rad_vb_eyeglasses" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_eyeglasses_true">
                                            Có/ <span class="text-primary">Yes</span>
                                        </label>
                                    </div>
                                    <div runat="server" id="vb_eyeglasses_wrapper" class="d-inline-block">
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_eyeglasses_note_wpa" />
                                            <span class="custom-control-label">NB giữ/ <span class="text-primary">With patient</span></span>
                                        </label>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_eyeglasses_note_wre" />
                                            <span class="custom-control-label">Thân nhân giữ/ <span class="text-primary">With relative</span></span>
                                        </label>
                                    </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_contact_lenses_change','')" type="radio" id="rad_vb_contact_lenses_false" runat="server" name="rad_vb_contact_lenses" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_contact_lenses_false">
                                            Không/ <span class="text-primary">No</span>
                                        </label>
                                    </div>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_contact_lenses_change','')" type="radio" id="rad_vb_contact_lenses_true" runat="server" name="rad_vb_contact_lenses" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_contact_lenses_true">
                                            Có/ <span class="text-primary">Yes</span>
                                        </label>
                                    </div>
                                    <div runat="server" id="vb_contact_lenses_wrapper" class="d-inline-block">
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_contact_lenses_note_wpa" />
                                            <span class="custom-control-label">NB giữ/ <span class="text-primary">With patient</span></span>
                                        </label>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_contact_lenses_note_wre" />
                                            <span class="custom-control-label">Thân nhân giữ/ <span class="text-primary">With relative</span></span>
                                        </label>
                                    </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_cash_jewelry_change','')" type="radio" id="rad_vb_cash_jewelry_false" runat="server" name="rad_vb_cash_jewelry" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_cash_jewelry_false">
                                            Không/ <span class="text-primary">No</span>
                                        </label>
                                    </div>
                                    <div class="custom-control custom-radio d-inline-block">
                                        <input onchange="__doPostBack('vb_cash_jewelry_change','')" type="radio" id="rad_vb_cash_jewelry_true" runat="server" name="rad_vb_cash_jewelry" class="custom-control-input" />
                                        <label class="custom-control-label" for="rad_vb_cash_jewelry_true">
                                            Có/ <span class="text-primary">Yes</span>
                                        </label>
                                    </div>
                                    <div runat="server" id="vb_cash_jewelry_wrapper" class="d-inline-block">
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_cash_jewelry_note_wpa" />
                                            <span class="custom-control-label">NB giữ/ <span class="text-primary">With patient</span></span>
                                        </label>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_cash_jewelry_note_wre" />
                                            <span class="custom-control-label">Thân nhân giữ/ <span class="text-primary">With relative</span></span>
                                        </label>
                                        <label class="custom-control custom-checkbox mb-1 d-inline">
                                            <input type="checkbox" class="custom-control-input" runat="server" id="cb_vb_cash_jewelry_note_hsb" />
                            ...
                            <div class="col-md-12 gt-2-a">
                                <label></label>
                                <asp:Label runat="server" ID="lbl_vb_other"></asp:Label>
                            ...
                            <div class="mt-2 d-flex">
                                ...
                                <asp:UpdatePanel runat="server" ID="UpdatePanel8" Class="d-inline-block">
                                    <ContentTemplate>
                                ...
                                <asp:UpdatePanel runat="server" ID="UpdatePanel15" Class="d-inline-block">
                                    <ContentTemplate>
    ...
    <script>
        function load_pain_annotation_Image() {
            ...
            if (pain_annotation_canvas != null) {
