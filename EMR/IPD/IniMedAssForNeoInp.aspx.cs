    ...
    public partial class IniMedAssForNeoInp : System.Web.UI.Page
    {
        ...
        public void Initial()
        {
            try
            {
                ...
                RadLabel1.Text = WebHelpers.loadRadGridHistoryLog(RadGrid1, Imani.Logs(varDocID, loc), out string _SignatureDate, out string _SignatureName);
