...
applicable for children and pregnant</span>)
                                                ...
                                                <fieldset class="row mb-2 final_screening">
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <fieldset class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label class="control-label mb-1 mr-2">Điểm/ <span class="text-primary">Score</span></label><label runat="server" id="nutrition_score"></label>
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label d-block">Hiện đang đau/ <span class="text-primary">Currently in pain</span></label>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">Pain Assessment Description</th>
                                                        <td>Location 1</td>
                                                        <td>Location 2</td>
                                                        <td>Location 3</td>
                                                    </tr>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-1">Sử dụng thuốc giảm đau/ <span class="text-primary">Using painkiller:</span></label>
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="custom-control custom-radio d-inline-block">
                                                <input type="radio" id="Radio1" runat="server" name="rad_oral_care_code" class="custom-control-input" />
                                                <label class="custom-control-label" for="rad_oral_care_code_oth">.</label>
                                            </div>

                                            <div class="custom-control custom-radio d-inline-block">
                                                <input type="radio" id="rad_oral_care_code_db" runat="server" name="rad_cur_in_pain" class="custom-control-input" />
                                                <label class="custom-control-label" for="rad_cur_in_pain_True">
                                                    Tự tắm tại giường/ <span class="text-primary">Dependent in bed</span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <label class="control-label mb-1 font-bold">Xoay sở tư thế trên giường/ <span class="text-primary">Turning in bed:</span></label>
                                        ...
                                        <div class="col-md-12">
                                            <label class="control-label mb-1 font-bold">Thuốc đã sử dụng/ <span class="text-primary">Medication used:</span></label>
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-2 font-bold">Tiền sử bị ngã/ <span class="text-primary">History of falling</span></label>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-2 font-bold">Có từ 2 bệnh lý trở lên/ <span class="text-primary">Secondary diagnosis</span></label>
                                            <div class="custom-control custom-radio">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-2 font-bold">Khả năng di chuyển/ <span class="text-primary">Ambulatory Aids</span></label>
                                            <div class="custom-control custom-radio">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-2 font-bold">Liệu pháp tiêm tĩnh mạch/ có khóa heparin <span class="text-primary">Intravenous therapy/heparin locked</span></label>
                                            <div class="custom-control custom-radio">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-2 font-bold">Dáng đi/di chuyển/ <span class="text-primary">Gait/ transferring</span></label>
                                            <div class="custom-control custom-radio">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-2 font-bold">Trạng thái tâm thần/ <span class="text-primary">Mental status</span></label>
                                            <div class="custom-control custom-radio">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label class="control-label mb-1 font-bold">TỔNG ĐIỂM/ <span class="text-primary">TOTAL SCORE:</span></label>
                                            <div class="form-group d-inline-block w-4">
                                                <webUI:TextField runat="server" ID="txt_fr_total_score" />
                                            </div>
                                        </div>
    ...
    <script>
        ...
        document.getElementById("cb_nutrition_score1_1").addEventListener("change", () => {
            nutrition_score1 = nutrition_scoreChange(["cb_nutrition_score1_1", "cb_nutrition_score1_2"]);
        ...
        document.getElementById("cb_nutrition_score2_1").addEventListener("change", () => {
            nutrition_score3 = nutrition_scoreChange(["cb_nutrition_score2_1", "cb_nutrition_score2_2", "cb_nutrition_score2_3"]);
            updateNutritionScore();
        });
        ...
        document.getElementById("cb_nutrition_score3_1").addEventListener("change", () => {
            nutrition_score3 = nutrition_scoreChange(["cb_nutrition_score3_1", "cb_nutrition_score3_2", "cb_nutrition_score3_3"]);
            updateNutritionScore();
        });
        ...
        function nutrition_scoreChange(_checkbox) {
            _checkbox.forEach(e => {
