                                ...
                                <div class="form-body">
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="form-group w-5 mb-1 d-inline-block">
...
applicable for children and pregnant</span>)
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <span id="rad_pro_cough_error" data-for="rad_pro_cough" data-message-error="this field is required" class="text-danger required"></span>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <span id="dpk_last_date_changed_error" data-for="dpk_last_date_changed" data-message-error="Ngày thay ống gần nhất/ Last Date Changed is required" class="text-danger required"></span>
                                        </div>
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <%--<span id="ind_catheter_error" data-for="cb_ind_catheter_true" data-message-error="Ngày thay ống gần nhất/ Last Date Changed is required" class="text-danger required"></span>--%>
                                    ...
                                    <fieldset class="row mb-2">
                                        ...
                                        <div class="col-md-12">
                                            <label class="control-label w-7 mb-2 mr-2">
                                                Tổng số điểm/ <span class="text-primary">Total Score</span>
                                                <icon:Calculator runat="server" Width="16" Height="16" />
                                            </label>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <span id="rad_other_hospital_error" data-for="rad_other_hospital" data-message-error="Dị ứng/ Allergy is required" class="text-danger required"></span>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            <div class="form-actions">
                                                ...
                                                <button type="button" onserverclick="validateForm1()" runat="server" id="btnSave" class="btn btn-primary waves-effect form-edit">
                                                        Save
                                                </button>
    ...
    <script src="../scripts/inpIniNurAss.js"></script>
