...
<div runat="server" id="datetimePanel">
    <div class="d-inline-block" runat="server" id="lblHour">
        <asp:Label class="d-inline-block align-top text-right" style="width: 30px" runat="server" id="prt_hour"></asp:Label>
    ...
    <div class="d-inline-block" runat="server" id="lblMinute">
        <asp:Label class="d-inline-block align-top text-right" style="width: 30px" runat="server" id="prt_minute"></asp:Label>
        <div class="d-inline-block">
    ...
    <div class="d-inline-block" runat="server" id="lblDay">
        ...
        <asp:Label class="d-inline-block align-top text-right" style="width: 30px" runat="server" id="prt_day"></asp:Label>
    </div>
    <div class="d-inline-block" runat="server" id="lblMonth">
        ...
        <asp:Label class="d-inline-block align-top text-right" style="width: 30px" runat="server" id="prt_month"></asp:Label>
    </div>
    <div class="d-inline-block" runat="server" id="lblYear">
        ...
        <asp:Label class="d-inline-block align-top text-right" style="width: 45px" runat="server" id="prt_year"></asp:Label>
    </div>
</div>
