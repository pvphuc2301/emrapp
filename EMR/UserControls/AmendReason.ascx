<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AmendReason.ascx.cs" Inherits="EMR.AmendReason" ClientIDMode="Static" %>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group mb-2">
            <webUI:TextField runat="server" ID="txtAmendReason" />
        </div>
